...
\section*{Intro}
\label{sec:org5bacf8a}
\begin{frame}[label={sec:org6014424}]{About us}
\vspace*{20px}
...
\begin{frame}[label={sec:org6b206d8}]{About the Forkshop}
\begin{itemize}
...
\begin{frame}[label={sec:org313ab13},fragile]{Whys}
 \begin{itemize}
...
\section*{Today}
\label{sec:org0e7f6dd}
\begin{frame}[label={sec:orgd243aeb}]{Agenda}
\begin{itemize}
...
\begin{frame}[label={sec:org3be2b74},fragile]{Before we start}
 \begin{minted}[]{bash}
...
\section{Type theory}
\label{sec:orgf50aa97}
\begin{frame}[label={sec:org639f56c}]{Values and types}
...
\begin{frame}[label={sec:org00646d1},fragile]{Nullary value constructors}
...
\begin{frame}[label={sec:org1ebff7a},fragile]{Unary value constructors: function}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org9860798},fragile]{Unary value constructors: class}
...
\begin{frame}[label={sec:orge697376},fragile]{Higher arity}
...
\begin{frame}[label={sec:org36fdd04},fragile]{Nullary type constructors}
...
\begin{frame}[label={sec:org8e6b6c8},fragile]{Unary type constructors}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgda1bb35},fragile]{Higher arity}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org3979907},fragile]{Kinds}
...
\begin{frame}[label={sec:orgbb770ee},fragile]{Examples}
 \begin{itemize}
...
\begin{frame}[label={sec:org45a4656},fragile]{Higher-order functions}
...
\begin{frame}[label={sec:orgba772d3},fragile]{Higher-order types (1)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org318d208},fragile]{Higher-order types (2)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org65fbfc2}]{Higher-order types (3)}
...
\begin{frame}[label={sec:org11408b1}]{The most important question}
\begin{center}
...
\section{Functor}
\label{sec:org204b047}
\begin{frame}[label={sec:org0759a75}]{Function Application}
...
\begin{frame}[label={sec:orga7f2656},fragile]{Function Application}
...
\begin{frame}[label={sec:org661eddb},fragile]{Function Application}
...
\begin{frame}[label={sec:orgba91133},fragile]{Context: optional value}
...
\begin{frame}[label={sec:org0794fda},fragile]{Context: optional value}
 \begin{itemize}
...
\begin{frame}[label={sec:orgb59d4d5},fragile]{Context: optional value}
 \begin{minted}[]{scala}
//  apply        : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:org8ed5ab0},fragile]{Many contexts}
 \begin{itemize}
...
\begin{frame}[label={sec:org46f089e},fragile]{Many applies}
 \begin{minted}[]{scala}
def apply           : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:org8aa6997}]{Repetition is}
\begin{center}
...
\begin{frame}[label={sec:orgaea3e67},fragile]{Functoriana}
 \begin{minted}[]{scala}
trait Functor[F[_]] {
...
\begin{frame}[label={sec:orgee5c25e},fragile]{Code responsibly, know the laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org4856386}]{Sum type: Option}
\begin{center}
...
\begin{frame}[label={sec:org0585c2c},fragile]{Breaking the Option}
 \begin{minted}[]{scala}
  fmap(identity)(value)
= identity(value)
= value
...
\begin{frame}[label={sec:orge8503fd},fragile]{Product type: List}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org82cf844},fragile,t]{Breaking the List}
 \begin{onlyenv}<1-2>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org4493029}]{What about the second rule?}
...
\begin{frame}[label={sec:org5209f07}]{There can be only one}
There is only one lawful implementation of Functor for a given type.
\end{frame}

\begin{frame}[label={sec:orga233903},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org85d3e17},fragile]{Outcome}
 \begin{itemize}
...
\label{sec:org1f154d2}

\begin{frame}[label={sec:org2d941ee},fragile]{Next step}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:org1bc0181},fragile]{Next step}
 \begin{minted}[]{scala}
def apply :  (A => B) =>   A  =>   B
...
\begin{frame}[label={sec:org9751077},fragile]{Solution}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:org30e6a5e},fragile]{Following the same idea}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org2d8e386},fragile]{What's about pure?}
 \begin{columns}
...
\begin{frame}[label={sec:org386ad5d},fragile]{Another perspective}
...
\begin{frame}[label={sec:org87d615c},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org6395651},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgcd1559e},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org9a1f2ef},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org817e6e8},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org4f4f45f},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgfee34c2},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{minted}[]{scala}
class MonoidalToApplicative[F[_]: Monoidal]() extends Applicative[F] {
  override def pure[A](a: A): F[A] = Monoidal[F].unit.fmap(_ => a)
...
\begin{frame}[label={sec:org890ab67},fragile]{Some symmetry}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orge9e9302},fragile]{Monoid part of \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Monoid[A] {
...
\begin{frame}[label={sec:orgab07652},fragile]{Applicative laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org793727a},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org376d8ed},fragile]{Conditionals}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org5c0cf40},fragile]{Outcome}
 \begin{itemize}
...
\section{Parsing}
\label{sec:orge2d8269}

\begin{frame}[label={sec:org695c6c2},fragile,t]{Parsing}
 \vspace*{20px}
...
\begin{frame}[label={sec:orgd54d825},fragile,t]{Simple parser}
 \begin{minted}[]{scala}
case class Parser[A](parse: String => ParserResult[A])
\end{minted}
...
\begin{frame}[label={sec:orga6bd647},fragile]{Abstracting \texttt{char}}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgd8eb8bc},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgfa93c7e},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org9238ed9},fragile,t]{(invalid) UUID parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org18707f5},fragile,t]{Space invaders}
 \begin{minted}[]{scala}
def uuid: Parser[String] = /* ... */
...
\begin{frame}[label={sec:orgaaa150e}]{So\ldots{}}
\begin{center}
\includegraphics[height=5cm]{images/applicative-confusion.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgd69fc04},fragile,t]{Simple case class example}
 \begin{onlyenv}<1->
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgc1288c4},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org8c3bb8b}]{Outcome}
\begin{itemize}
...
\section{Validation}
\label{sec:org3bac90c}

\begin{frame}[label={sec:org342eea8},fragile]{Validation}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgf77e759},fragile]{Person}
 \begin{minted}[]{scala}
case class Person(name: String, age: Int)
\end{minted}
...
\begin{frame}[label={sec:orge4e7d18},fragile]{Person}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgbab63b4},fragile]{Quest for 'all errors'}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org48eab13},fragile]{What's wrong with Either?}
...
\begin{frame}[label={sec:org1ba17ef},fragile]{Doing as much as we can}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgcbf7836},fragile]{Coding time}
 \begin{itemize}
...
\section*{Final words}
\label{sec:org789f7a1}
\begin{frame}[label={sec:org33a9346},fragile]{Recap}
 \begin{onlyenv}
\begin{itemize}
...
\section*{References}
\label{sec:orge9ad3be}
\begin{frame}[label={sec:org9176d85}]{References}
\begin{itemize}
...
\section{Questions?}
\label{sec:org344de49}

\section{Thank you very much!}
\label{sec:org6ea22bc}
\end{document}
