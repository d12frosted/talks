...
\section*{Intro}
\label{sec:org49c60b5}
\begin{frame}[label={sec:org6160e92}]{About us}
\vspace*{20px}
...
\begin{frame}[label={sec:org288157f}]{About the Forkshop}
\begin{itemize}
...
\begin{frame}[label={sec:org9f08e8d},fragile]{Whys}
 \begin{itemize}
...
\section*{Today}
\label{sec:org34fed2c}
\begin{frame}[label={sec:org0ddc8b1}]{Agenda}
\begin{itemize}
...
\begin{frame}[label={sec:org38fd3e1},fragile]{Before we start}
 \begin{minted}[]{bash}
...
\section{Type theory}
\label{sec:org8654b89}
\begin{frame}[label={sec:orgd3d1d25}]{Values and types}
...
\begin{frame}[label={sec:orgf9d7b84},fragile]{Nullary value constructors}
...
\begin{frame}[label={sec:orgb747fef},fragile]{Unary value constructors: function}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgc86162a},fragile]{Unary value constructors: class}
...
\begin{frame}[label={sec:org7553899},fragile]{Higher arity}
...
\begin{frame}[label={sec:org016c081},fragile]{Nullary type constructors}
...
\begin{frame}[label={sec:org5d08b1e},fragile]{Unary type constructors}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org8b1567c},fragile]{Higher arity}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org15b85dc},fragile]{Kinds}
...
\begin{frame}[label={sec:orgbd02a95},fragile]{Examples}
 \begin{itemize}
...
\begin{frame}[label={sec:org3140d0b},fragile]{Higher-order functions}
...
\begin{frame}[label={sec:orgdb7cf67},fragile]{Higher-order types (1)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgfc26343},fragile]{Higher-order types (2)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orge590e05}]{Higher-order types (3)}
...
\begin{frame}[label={sec:org7cff9ce}]{The most important question}
\begin{center}
...
\section{Functor}
\label{sec:org4f686c4}
\begin{frame}[label={sec:org5b49790}]{Function Application}
...
\begin{frame}[label={sec:org05ca1eb},fragile]{Function Application}
...
\begin{frame}[label={sec:orgb4203db},fragile]{Function Application}
...
\begin{frame}[label={sec:orgc7c671b},fragile]{Context: optional value}
...
\begin{frame}[label={sec:orge61fd72},fragile]{Context: optional value}
 \begin{itemize}
...
\begin{frame}[label={sec:org488bbb0},fragile]{Context: optional value}
 \begin{minted}[]{scala}
//  apply        : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:orgb7604a4},fragile]{Many contexts}
 \begin{itemize}
...
\begin{frame}[label={sec:orgc92b676},fragile]{Many applies}
 \begin{minted}[]{scala}
def apply           : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:org938332a}]{Repetition is}
\begin{center}
...
\begin{frame}[label={sec:org6cf02c1},fragile]{Functoriana}
 \begin{minted}[]{scala}
trait Functor[F[_]] {
...
\begin{frame}[label={sec:org887607b},fragile]{Code responsibly, know the laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org2ac88e1}]{Sum type: Option}
\begin{center}
...
\begin{frame}[label={sec:orga3cccb4},fragile]{Breaking the Option}
 \begin{minted}[]{scala}
  fmap(identity)(value)
= identity(value)
= value
...
\begin{frame}[label={sec:org081b89b},fragile]{Product type: List}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgbfed88a},fragile,t]{Breaking the List}
 \begin{onlyenv}<1-2>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgdd8bcc4}]{What about the second rule?}
...
\begin{frame}[label={sec:org4e5865b}]{There can be only one}
There is only one lawful implementation of Functor for a given type.
\end{frame}

\begin{frame}[label={sec:org8ed2816},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org62570bd},fragile]{Outcome}
 \begin{itemize}
...
\label{sec:orge4535fb}

\begin{frame}[label={sec:org1e32a61},fragile]{Next step}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:org590f614},fragile]{Next step}
 \begin{minted}[]{scala}
def apply :  (A => B) =>   A  =>   B
...
\begin{frame}[label={sec:orgbb147c0},fragile]{Solution}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:org985ed8c},fragile]{Following the same idea}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org444a46d},fragile]{What's about pure?}
 \begin{columns}
...
\begin{frame}[label={sec:org5d5a19e},fragile]{Another perspective}
...
\begin{frame}[label={sec:org1dfe42a},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org28802d0},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org5efa4db},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org26e1fb0},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org8b62a05},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgc3cd958},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org9a70f6e},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{minted}[]{scala}
class MonoidalToApplicative[F[_]: Monoidal]() extends Applicative[F] {
  override def pure[A](a: A): F[A] = Monoidal[F].unit.fmap(_ => a)
...
\begin{frame}[label={sec:org9292261},fragile]{Some symmetry}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org826ca3b},fragile]{Monoid part of \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Monoid[A] {
...
\begin{frame}[label={sec:org1407176},fragile]{Applicative laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org4c4a2aa},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org48933d4},fragile]{Conditionals}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org0323b81},fragile]{Outcome}
 \begin{itemize}
...
\section{Parsing}
\label{sec:org67863a7}

\begin{frame}[label={sec:orgd4b580f},fragile,t]{Parsing}
 \vspace*{20px}
...
\begin{frame}[label={sec:org03d9680},fragile,t]{Simple parser}
 \begin{minted}[]{scala}
case class Parser[A](parse: String => ParserResult[A])
\end{minted}
...
\begin{frame}[label={sec:orgd423bd1},fragile]{Abstracting \texttt{char}}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org462442f},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgeac227a},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgaadaa96},fragile,t]{(invalid) UUID parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgf6a1988},fragile,t]{Space invaders}
 \begin{minted}[]{scala}
def uuid: Parser[String] = /* ... */
...
\begin{frame}[label={sec:org13c342b}]{So\ldots{}}
\begin{center}
\includegraphics[height=5cm]{images/applicative-confusion.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgad4502e},fragile,t]{Simple case class example}
 \begin{onlyenv}<1->
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org88111d8},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org36f8cb7}]{Outcome}
\begin{itemize}
...
\section{Validation}
\label{sec:org9ade0fd}

\begin{frame}[label={sec:orgf917d30},fragile]{Validation}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org20c962c},fragile]{Person}
 \begin{minted}[]{scala}
case class Person(name: String, age: Int)
\end{minted}
...
\begin{frame}[label={sec:org86a2571},fragile]{Person}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org50f627b},fragile]{Quest for 'all errors'}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgcdcd7c3},fragile]{What's wrong with Either?}
...
\begin{frame}[label={sec:org06ddbf0},fragile]{Doing as much as we can}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org6544da9},fragile]{Coding time}
 \begin{itemize}
...
\section*{Final words}
\label{sec:orgd89ad38}
\begin{frame}[label={sec:orgf9ac349},fragile]{Recap}
 \begin{onlyenv}
\begin{itemize}
...
\section{Questions?}
\label{sec:org2772e31}

\section{Thank you very much!}
\label{sec:orgf63d754}
\end{document}
