...
\section*{Intro}
\label{sec:org4ddbb6c}
\begin{frame}[label={sec:orge5d1c72}]{About us}
\vspace*{20px}
...
\begin{frame}[label={sec:orgb457c53}]{About the Forkshop}
\begin{itemize}
...
\begin{frame}[label={sec:org8294604},fragile]{Whys}
 \begin{itemize}
...
\section*{Today}
\label{sec:orgff5eb5c}
\begin{frame}[label={sec:org7f70a3f}]{Agenda}
\begin{itemize}
...
\begin{frame}[label={sec:org8802c80},fragile]{Before we start}
 \begin{minted}[]{bash}
...
\section{Type theory}
\label{sec:org8cd5140}
\begin{frame}[label={sec:orgd32a1a7}]{Values and types}
...
\begin{frame}[label={sec:org4bf33cd},fragile]{Nullary value constructors}
...
\begin{frame}[label={sec:org9785030},fragile]{Unary value constructors: function}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org0318427},fragile]{Unary value constructors: class}
...
\begin{frame}[label={sec:orgdc07bb8},fragile]{Higher arity}
...
\begin{frame}[label={sec:org14004a3},fragile]{Nullary type constructors}
...
\begin{frame}[label={sec:orge05b594},fragile]{Unary type constructors}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org4b7ac93},fragile]{Higher arity}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org6e6fb1f},fragile]{Kinds}
...
\begin{frame}[label={sec:org639a5fa},fragile]{Examples}
 \begin{itemize}
...
\begin{frame}[label={sec:org57edd20},fragile]{Higher-order functions}
...
\begin{frame}[label={sec:orgac947c2},fragile]{Higher-order types (1)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org2fa0317},fragile]{Higher-order types (2)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org959bd92}]{Higher-order types (3)}
...
\begin{frame}[label={sec:orgfc946d4}]{The most important question}
\begin{center}
...
\section{Functor}
\label{sec:orgce2ac15}
\begin{frame}[label={sec:org1de14ee}]{Function Application}
...
\begin{frame}[label={sec:org9761def},fragile]{Function Application}
...
\begin{frame}[label={sec:orgeb4be3f},fragile]{Function Application}
...
\begin{frame}[label={sec:orgb53f7d0},fragile]{Context: optional value}
...
\begin{frame}[label={sec:org8cdf854},fragile]{Context: optional value}
 \begin{itemize}
...
\begin{frame}[label={sec:org5066607},fragile]{Context: optional value}
 \begin{minted}[]{scala}
//  apply        : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:orgb74247f},fragile]{Many contexts}
 \begin{itemize}
...
\begin{frame}[label={sec:org11844ed},fragile]{Many applies}
 \begin{minted}[]{scala}
def apply           : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:orgb84574a}]{Repetition is}
\begin{center}
...
\begin{frame}[label={sec:orgc6e5e1b},fragile]{Functoriana}
 \begin{minted}[]{scala}
trait Functor[F[_]] {
...
\begin{frame}[label={sec:org564493e},fragile]{Code responsibly, know the laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org33fe072}]{Sum type: Option}
\begin{center}
...
\begin{frame}[label={sec:org22378d6},fragile]{Breaking the Option}
 \begin{minted}[]{scala}
  fmap(identity)(value)
= identity(value)
= value
...
\begin{frame}[label={sec:org8085f89},fragile]{Product type: List}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org972ac39},fragile,t]{Breaking the List}
 \begin{onlyenv}<1-2>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org5e62e87}]{What about the second rule?}
...
\begin{frame}[label={sec:org54baed2}]{There can be only one}
There is only one lawful implementation of Functor for a given type.
\end{frame}

\begin{frame}[label={sec:org38b845c},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org2d19170},fragile]{Outcome}
 \begin{itemize}
...
\label{sec:orgeec1801}

\begin{frame}[label={sec:orgea42d5d},fragile]{Next step}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:org737334c},fragile]{Next step}
 \begin{minted}[]{scala}
def apply :  (A => B) =>   A  =>   B
...
\begin{frame}[label={sec:orgf828de8},fragile]{Solution}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:org2dac4bd},fragile]{Following the same idea}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgd0d2b7b},fragile]{What's about pure?}
 \begin{columns}
...
\begin{frame}[label={sec:orgd65611d},fragile]{Another perspective}
...
\begin{frame}[label={sec:org0f93e26},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org39aba67},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orga3bda3b},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org9576a3a},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org947323b},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org9a71e25},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orga53105b},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{minted}[]{scala}
class MonoidalToApplicative[F[_]: Monoidal]() extends Applicative[F] {
  override def pure[A](a: A): F[A] = Monoidal[F].unit.fmap(_ => a)
...
\begin{frame}[label={sec:org804a9be},fragile]{Some symmetry}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org8ab6cd6},fragile]{Monoid part of \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Monoid[A] {
...
\begin{frame}[label={sec:org0fdaed7},fragile]{Applicative laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org4d5dc99},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:orge55536b},fragile]{Conditionals}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org51a5c9f},fragile]{Outcome}
 \begin{itemize}
...
\section{Parsing}
\label{sec:org542f2eb}

\begin{frame}[label={sec:org869224d},fragile,t]{Parsing}
 \vspace*{20px}
...
\begin{frame}[label={sec:orga38c85b},fragile,t]{Simple parser}
 \begin{minted}[]{scala}
case class Parser[A](parse: String => ParserResult[A])
\end{minted}
...
\begin{frame}[label={sec:org6687bca},fragile]{Abstracting \texttt{char}}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orge1f8ed5},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org57c58b8},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgb6d6675},fragile,t]{(invalid) UUID parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org6bab425},fragile,t]{Space invaders}
 \begin{minted}[]{scala}
def uuid: Parser[String] = /* ... */
...
\begin{frame}[label={sec:org2fe8b24}]{So\ldots{}}
\begin{center}
\includegraphics[height=5cm]{images/applicative-confusion.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:org298075d},fragile,t]{Simple case class example}
 \begin{onlyenv}<1->
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgb980342},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:orgdcd2e25}]{Outcome}
\begin{itemize}
...
\section{Validation}
\label{sec:org2b2b414}

\begin{frame}[label={sec:orgaea20ec},fragile]{Validation}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org823319a},fragile]{Person}
 \begin{minted}[]{scala}
case class Person(name: String, age: Int)
\end{minted}
...
\begin{frame}[label={sec:org8322951},fragile]{Person}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org496d10f},fragile]{Quest for 'all errors'}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org83587bd},fragile]{What's wrong with Either?}
...
\begin{frame}[label={sec:org966e7f8},fragile]{Doing as much as we can}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org91bfbdf},fragile]{Coding time}
 \begin{itemize}
...
\section*{Final words}
\label{sec:org8301498}
\begin{frame}[label={sec:org38ec113},fragile]{Recap}
 \begin{onlyenv}
\begin{itemize}
...
\section*{References}
\label{sec:org847190c}
\begin{frame}[label={sec:org62aff5b}]{References}
\begin{itemize}
...
\section{Questions?}
\label{sec:orgecfa40b}

\section{Thank you very much!}
\label{sec:org78f1d4f}
\end{document}
