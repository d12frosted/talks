...
\section*{Intro}
\label{sec:orgd0c7491}
\begin{frame}[label={sec:org36ccdcb}]{About us}
\vspace*{20px}
...
\begin{frame}[label={sec:orgab206a1}]{About the Forkshop}
\begin{itemize}
...
\begin{frame}[label={sec:org33bf984},fragile]{Whys}
 \begin{itemize}
...
\section*{Today}
\label{sec:org50bb4bb}
\begin{frame}[label={sec:org0e85617}]{Agenda}
\begin{itemize}
...
\begin{frame}[label={sec:orgda97e90},fragile]{Before we start}
 \begin{minted}[]{bash}
...
\section{Type theory}
\label{sec:orgc3a221c}
\begin{frame}[label={sec:org1117853}]{Values and types}
...
\begin{frame}[label={sec:orgb9d0341},fragile]{Nullary value constructors}
...
\begin{frame}[label={sec:org4c544ea},fragile]{Unary value constructors: function}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgd038f95},fragile]{Unary value constructors: class}
...
\begin{frame}[label={sec:org541d2bd},fragile]{Higher arity}
...
\begin{frame}[label={sec:orge27c028},fragile]{Nullary type constructors}
...
\begin{frame}[label={sec:org2d73f7b},fragile]{Unary type constructors}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org9573cdb},fragile]{Higher arity}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org3de6a06},fragile]{Kinds}
...
\begin{frame}[label={sec:orgeca402a},fragile]{Examples}
 \begin{itemize}
...
\begin{frame}[label={sec:org2496b00},fragile]{Higher-order functions}
...
\section{Functor}
\label{sec:org4e0e9ec}
\begin{frame}[label={sec:orgad1527f}]{Function Application}
...
\begin{frame}[label={sec:orgad19e97},fragile]{Function Application}
...
\begin{frame}[label={sec:org6c94d52},fragile]{Function Application}
...
\begin{frame}[label={sec:orgdc69ad7},fragile]{Context: optional value}
...
\begin{frame}[label={sec:org9c6e7b9},fragile]{Context: optional value}
 \begin{itemize}
...
\begin{frame}[label={sec:org069dee0},fragile]{Context: optional value}
 \begin{minted}[]{scala}
//  apply        : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:orgf115e5d},fragile]{Many contexts}
 \begin{itemize}
...
\begin{frame}[label={sec:orgf788963},fragile]{Many applies}
 \begin{minted}[]{scala}
def apply           : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:orgeae5692}]{Repetition is}
\begin{center}
...
\begin{frame}[label={sec:org27398f1},fragile]{Functoriana}
 \begin{minted}[]{scala}
trait Functor[F[_]] {
...
\begin{frame}[label={sec:org13a287b},fragile]{Product type: List}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org315417c},fragile]{Another perspective}
...
\begin{frame}[label={sec:org369b73b},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org4ebf44f},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org165b2c3},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgf063a3c},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org7f7fbc8},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org508c003},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org4e4a80b},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{minted}[]{scala}
class MonoidalToApplicative[F[_]: Monoidal]() extends Applicative[F] {
  override def pure[A](a: A): F[A] = Monoidal[F].unit.fmap(_ => a)
...
\begin{frame}[label={sec:org0baabf4},fragile]{Monoid part of \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Monoid[A] {
...
\begin{frame}[label={sec:org4da6e5e},fragile]{Applicative laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org14bc36a},fragile,t]{Parsing}
 \vspace*{20px}
...
\begin{frame}[label={sec:org649e156},fragile]{Abstracting \texttt{char}}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org52084ba},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org26af223},fragile,t]{Space invaders}
 \begin{minted}[]{scala}
def uuid: Parser[String] = /* ... */
...
\begin{frame}[label={sec:org9172b60}]{So\ldots{}}
\begin{center}
...
\begin{frame}[label={sec:org642d429},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org1c295fc}]{Outcome}
\begin{itemize}
...
\section{Validation}
\label{sec:org86c9684}

\begin{frame}[label={sec:org50c471a},fragile]{Validation}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org7a9ef31},fragile]{Person}
 \begin{minted}[]{scala}
case class Person(name: String, age: Int)
\end{minted}
...
\begin{frame}[label={sec:orgf462ad1},fragile]{Person}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org82682e6},fragile]{Quest for 'all errors'}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org7358936},fragile]{What's wrong with Either?}
...
\begin{frame}[label={sec:org1c0856b},fragile]{Doing as much as we can}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgc357da5},fragile]{Coding time}
 \begin{itemize}
