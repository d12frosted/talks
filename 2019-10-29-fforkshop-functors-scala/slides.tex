...
\section*{Intro}
\label{sec:org77b1806}
\begin{frame}[label={sec:orgcf2cfd1}]{About us}
\vspace*{20px}
...
\begin{frame}[label={sec:orgc7367fe}]{About the Forkshop}
\begin{itemize}
...
\begin{frame}[label={sec:org399704a},fragile]{Whys}
 \begin{itemize}
...
\section*{Today}
\label{sec:orga113bd8}
\begin{frame}[label={sec:orgf803a73}]{Agenda}
\begin{itemize}
...
\begin{frame}[label={sec:orgbc7836e},fragile]{Before we start}
 \begin{minted}[]{bash}
...
\section{Type theory}
\label{sec:org2463806}
\begin{frame}[label={sec:org87294ef}]{Values and types}
...
\begin{frame}[label={sec:org0378acf},fragile]{Nullary value constructors}
...
\begin{frame}[label={sec:org93263d6},fragile]{Unary value constructors: function}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org92a604b},fragile]{Unary value constructors: class}
...
\begin{frame}[label={sec:orgdb4f053},fragile]{Higher arity}
...
\begin{frame}[label={sec:org2600df6},fragile]{Nullary type constructors}
...
\begin{frame}[label={sec:org6d01985},fragile]{Unary type constructors}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgae62ec4},fragile]{Higher arity}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orge8671de},fragile]{Kinds}
...
\begin{frame}[label={sec:orgd68d0cf},fragile]{Examples}
 \begin{itemize}
...
\begin{frame}[label={sec:org001fc1d},fragile]{Higher-order functions}
...
\begin{frame}[label={sec:org3344b7d},fragile]{Higher-order types (1)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org38206f7},fragile]{Higher-order types (2)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org73f51c5}]{Higher-order types (3)}
...
\begin{frame}[label={sec:org8f0fcde}]{The most important question}
\begin{center}
...
\section{Functor}
\label{sec:orge16bf2f}
\begin{frame}[label={sec:org069617d}]{Function Application}
...
\begin{frame}[label={sec:org783e96a},fragile]{Function Application}
...
\begin{frame}[label={sec:org371b164},fragile]{Function Application}
...
\begin{frame}[label={sec:orga1e2a2c},fragile]{Context: optional value}
...
\begin{frame}[label={sec:org5609659},fragile]{Context: optional value}
 \begin{itemize}
...
\begin{frame}[label={sec:orgbdfdbe2},fragile]{Context: optional value}
 \begin{minted}[]{scala}
//  apply        : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:org72913e5},fragile]{Many contexts}
 \begin{itemize}
...
\begin{frame}[label={sec:orgfc879db},fragile]{Many applies}
 \begin{minted}[]{scala}
def apply           : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:org3306809}]{Repetition is}
\begin{center}
...
\begin{frame}[label={sec:org8039027},fragile]{Functoriana}
 \begin{minted}[]{scala}
trait Functor[F[_]] {
...
\begin{frame}[label={sec:orge331d33},fragile]{Code responsibly, know the laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org8182853}]{Sum type: Option}
\begin{center}
...
\begin{frame}[label={sec:org93d34ad},fragile]{Product type: List}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgd57f3b3},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org0bd7603},fragile]{Breaking the first rule}
 \begin{minted}[]{scala}
object OptionImpl {
  implicit val optionFunctor: Functor[Option] = {
    def fmap[A, B]: (A => B) => Option[A] => Option[B] =
...
\begin{frame}[label={sec:org018c7e4}]{Breaking the second rule}
...
\begin{frame}[label={sec:org9f2c5db},fragile]{Outcome}
 \begin{itemize}
...
\label{sec:orgc212a11}

\begin{frame}[label={sec:orga351364},fragile]{Next step}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:orgf419664},fragile]{Next step}
 \begin{minted}[]{scala}
def apply :  (A => B) =>   A  =>   B
...
\begin{frame}[label={sec:orgcf2d7c0},fragile]{Solution}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:org12666aa},fragile]{Following the same idea}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org2bf2e23},fragile]{What's about pure?}
 \begin{enumerate}
...
\begin{frame}[label={sec:orgf81b84c},fragile]{Another perspective}
...
\begin{frame}[label={sec:org43aa325},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgbf60240},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org3b0473a},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgefa7766},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orga58e029},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orge5d01b5},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org29edc46},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{minted}[]{scala}
class MonoidalToApplicative[F[_]: Monoidal]() extends Applicative[F] {
  override def pure[A](a: A): F[A] = Monoidal[F].unit.fmap(_ => a)
...
\begin{frame}[label={sec:orgdaf67f0},fragile]{Monoid part of \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Monoid[A] {
...
\begin{frame}[label={sec:orgcfcdbbf},fragile]{Applicative laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org2235c94},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:orgac3ed19},fragile]{Outcome}
 \begin{itemize}
...
\section{Parsing}
\label{sec:org33a6996}

\begin{frame}[label={sec:orgad6e1a7},fragile,t]{Parsing}
 \vspace*{20px}
...
\begin{frame}[label={sec:org394074c},fragile,t]{Simple parser}
 \vspace*{20px}
...
\begin{frame}[label={sec:org15ca294},fragile]{Abstracting \texttt{char}}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org1e19524},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org2944b8d},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org350ed4c},fragile,t]{(invalid) UUID parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org62ca790},fragile,t]{Space invaders}
 \begin{minted}[]{scala}
def uuid: Parser[String] = /* ... */
...
\begin{frame}[label={sec:orgbb2ef4e}]{So\ldots{}}
\begin{center}
\includegraphics[height=5cm]{images/applicative-confusion.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgffbf79a},fragile,t]{Simple case class example}
 \begin{onlyenv}<1->
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org123d4e5},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org5e1f8c9}]{Outcome}
\begin{itemize}
...
\section{Validation}
\label{sec:org571a06e}

\begin{frame}[label={sec:org1dbb02a},fragile]{Validation}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org319b009},fragile]{Person}
 \begin{minted}[]{scala}
case class Person(name: String, age: Int)
\end{minted}
...
\begin{frame}[label={sec:orgee9ea1a},fragile]{Person}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org2a0f4b4},fragile]{Quest for 'all errors'}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org67f0271},fragile]{What's wrong with Either?}
...
\begin{frame}[label={sec:org3d3f7af},fragile]{Doing as much as we can}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org40a3930},fragile]{Coding time}
 \begin{itemize}
...
\section*{Final words}
\label{sec:org2a3414e}
\begin{frame}[label={sec:orgbc62fa5},fragile]{Recap}
 \begin{itemize}
...
\section{Questions?}
\label{sec:orgd9eb995}

\section{Thank you very much!}
\label{sec:orgbef94b4}
\end{document}
