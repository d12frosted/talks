...
\section*{Intro}
\label{sec:orga177546}
\begin{frame}[label={sec:org65e81cb}]{About us}
\vspace*{20px}
...
\begin{frame}[label={sec:org4f45079}]{About the Forkshop}
\begin{itemize}
...
\begin{frame}[label={sec:org3a5a5b2},fragile]{Whys}
 \begin{itemize}
...
\section*{Today}
\label{sec:orgb8e32cf}
\begin{frame}[label={sec:org537068f}]{Agenda}
\begin{itemize}
...
\begin{frame}[label={sec:orgd6161f2},fragile]{Before we start}
 \begin{minted}[]{bash}
...
\section{Type theory}
\label{sec:orgc846dd5}
\begin{frame}[label={sec:org3bdaa9f}]{Values and types}
...
\begin{frame}[label={sec:org0193c53},fragile]{Nullary value constructors}
...
\begin{frame}[label={sec:orgd48bf62},fragile]{Unary value constructors: function}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orge789f1b},fragile]{Unary value constructors: class}
...
\begin{frame}[label={sec:org80ffea3},fragile]{Higher arity}
...
\begin{frame}[label={sec:org8c811e0},fragile]{Nullary type constructors}
...
\begin{frame}[label={sec:org7428153},fragile]{Unary type constructors}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org4db9936},fragile]{Higher arity}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org8fba854},fragile]{Kinds}
...
\begin{frame}[label={sec:org26314b6},fragile]{Examples}
 \begin{itemize}
...
\begin{frame}[label={sec:org5588c21},fragile]{Higher-order functions}
...
\begin{frame}[label={sec:org1688ef9},fragile]{Higher-order types (1)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org89642cd},fragile]{Higher-order types (2)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgbe5b340}]{Higher-order types (3)}
...
\begin{frame}[label={sec:orgf427045}]{The most important question}
\begin{center}
...
\section{Functor}
\label{sec:org14fef3a}
\begin{frame}[label={sec:orgdefe575}]{Function Application}
...
\begin{frame}[label={sec:orgf130163},fragile]{Function Application}
...
\begin{frame}[label={sec:org3657911},fragile]{Function Application}
...
\begin{frame}[label={sec:org4896c56},fragile]{Context: optional value}
...
\begin{frame}[label={sec:orgfb36ee9},fragile]{Context: optional value}
 \begin{itemize}
...
\begin{frame}[label={sec:org52aed71},fragile]{Context: optional value}
 \begin{minted}[]{scala}
//  apply        : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:org7176acf},fragile]{Many contexts}
 \begin{itemize}
...
\begin{frame}[label={sec:org486811e},fragile]{Many applies}
 \begin{minted}[]{scala}
def apply           : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:org45452fa}]{Repetition is}
\begin{center}
...
\begin{frame}[label={sec:org2138931},fragile]{Functoriana}
 \begin{minted}[]{scala}
trait Functor[F[_]] {
...
\begin{frame}[label={sec:org3e6449c},fragile]{Code responsibly, know the laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org4e87b4d}]{Sum type: Option}
\begin{center}
...
\begin{frame}[label={sec:org419ae37},fragile]{Breaking the Option}
 \begin{minted}[]{scala}
  fmap(identity)(value)
= identity(value)
= value
...
\begin{frame}[label={sec:org72e78f8},fragile]{Product type: List}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org2acc517},fragile,t]{Breaking the List}
 \begin{onlyenv}<1-2>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org908e849}]{What about the second rule?}
...
\begin{frame}[label={sec:org27adb07},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org4e3b178},fragile]{Outcome}
 \begin{itemize}
...
\label{sec:org9ba79c3}

\begin{frame}[label={sec:org1660e87},fragile]{Next step}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:orgc2c3fb4},fragile]{Next step}
 \begin{minted}[]{scala}
def apply :  (A => B) =>   A  =>   B
...
\begin{frame}[label={sec:org7f3af3b},fragile]{Solution}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:orga5bca32},fragile]{Following the same idea}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgaf90cc3},fragile]{What's about pure?}
 \begin{enumerate}
...
\begin{frame}[label={sec:orgccbb8bb},fragile]{Another perspective}
...
\begin{frame}[label={sec:orgc9a6646},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orga15efbf},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org53831fe},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org94583a8},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgd63f140},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org9d84612},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org9f02fac},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{minted}[]{scala}
class MonoidalToApplicative[F[_]: Monoidal]() extends Applicative[F] {
  override def pure[A](a: A): F[A] = Monoidal[F].unit.fmap(_ => a)
...
\begin{frame}[label={sec:orge22e213},fragile]{Monoid part of \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Monoid[A] {
...
\begin{frame}[label={sec:orgeb96919},fragile]{Applicative laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org7a62e5b},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:orgb258dc8},fragile]{Outcome}
 \begin{itemize}
...
\section{Parsing}
\label{sec:orgd7c777a}

\begin{frame}[label={sec:org8c19ab0},fragile,t]{Parsing}
 \vspace*{20px}
...
\begin{frame}[label={sec:orgd87621f},fragile,t]{Simple parser}
 \vspace*{20px}
...
\begin{frame}[label={sec:org619bd69},fragile]{Abstracting \texttt{char}}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgb803906},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org2601a74},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org7c5ef0b},fragile,t]{(invalid) UUID parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org0820cb2},fragile,t]{Space invaders}
 \begin{minted}[]{scala}
def uuid: Parser[String] = /* ... */
...
\begin{frame}[label={sec:orgf0a8110}]{So\ldots{}}
\begin{center}
\includegraphics[height=5cm]{images/applicative-confusion.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:org8392d5f},fragile,t]{Simple case class example}
 \begin{onlyenv}<1->
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org2c4c658},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:orge93e65e}]{Outcome}
\begin{itemize}
...
\section{Validation}
\label{sec:orgddcf83c}

\begin{frame}[label={sec:org442bdd4},fragile]{Validation}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org50aebaa},fragile]{Person}
 \begin{minted}[]{scala}
case class Person(name: String, age: Int)
\end{minted}
...
\begin{frame}[label={sec:orga4564fc},fragile]{Person}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org4bc6c04},fragile]{Quest for 'all errors'}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org625eb38},fragile]{What's wrong with Either?}
...
\begin{frame}[label={sec:org56f43a9},fragile]{Doing as much as we can}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgd53b8d4},fragile]{Coding time}
 \begin{itemize}
...
\section*{Final words}
\label{sec:orgc38aa3f}
\begin{frame}[label={sec:org619d405},fragile]{Recap}
 \begin{onlyenv}
\begin{itemize}
...
\section{Questions?}
\label{sec:org88eafaf}

\section{Thank you very much!}
\label{sec:org0320666}
\end{document}
