...
\section*{Intro}
\label{sec:org93fb255}
\begin{frame}[label={sec:orgd1fea75}]{About us}
\vspace*{20px}
...
\begin{frame}[label={sec:org283e068}]{About the Forkshop}
\begin{itemize}
...
\begin{frame}[label={sec:org8f07386},fragile]{Whys}
 \begin{itemize}
...
\section*{Today}
\label{sec:org557871e}
\begin{frame}[label={sec:org654ca3c}]{Agenda}
\begin{itemize}
...
\begin{frame}[label={sec:orgdce0017},fragile]{Before we start}
 \begin{minted}[]{bash}
...
\section{Type theory}
\label{sec:org6ea5211}
\begin{frame}[label={sec:org8624e85}]{Values and types}
...
\begin{frame}[label={sec:orgcd130f9},fragile]{Nullary value constructors}
...
\begin{frame}[label={sec:org6436c70},fragile]{Unary value constructors: function}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgf73224f},fragile]{Unary value constructors: class}
...
\begin{frame}[label={sec:org01665c7},fragile]{Higher arity}
...
\begin{frame}[label={sec:org6e8b192},fragile]{Nullary type constructors}
...
\begin{frame}[label={sec:orgf228829},fragile]{Unary type constructors}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgc19965d},fragile]{Higher arity}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orga798da2},fragile]{Kinds}
...
\begin{frame}[label={sec:org460750c},fragile]{Examples}
 \begin{itemize}
...
\begin{frame}[label={sec:orgd89ee99},fragile]{Higher-order functions}
...
\begin{frame}[label={sec:orgfaff172},fragile]{Higher-order types (1)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org113adf9},fragile]{Higher-order types (2)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgfd283a3}]{Higher-order types (3)}
...
\begin{frame}[label={sec:orgb449307}]{The most important question}
\begin{center}
...
\section{Functor}
\label{sec:org7d5878d}
\begin{frame}[label={sec:orge2212c8}]{Function Application}
...
\begin{frame}[label={sec:org033da47},fragile]{Function Application}
...
\begin{frame}[label={sec:orge028d05},fragile]{Function Application}
...
\begin{frame}[label={sec:org60f4434},fragile]{Context: optional value}
...
\begin{frame}[label={sec:orgb288361},fragile]{Context: optional value}
 \begin{itemize}
...
\begin{frame}[label={sec:orge7e3f0d},fragile]{Context: optional value}
 \begin{minted}[]{scala}
//  apply        : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:org2afa928},fragile]{Many contexts}
 \begin{itemize}
...
\begin{frame}[label={sec:orgb6cdde5},fragile]{Many applies}
 \begin{minted}[]{scala}
def apply           : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:orgb54651e}]{Repetition is}
\begin{center}
...
\begin{frame}[label={sec:orga9e1584},fragile]{Functoriana}
 \begin{minted}[]{scala}
trait Functor[F[_]] {
...
\begin{frame}[label={sec:orgd474178},fragile]{Code responsibly, know the laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org5221043}]{Sum type: Option}
\begin{center}
...
\begin{frame}[label={sec:org3e73dfd},fragile]{Breaking the Option}
 \begin{minted}[]{scala}
  fmap(identity)(value)
= identity(value)
= value
...
\begin{frame}[label={sec:orgbee2ce7},fragile]{Product type: List}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgf3494aa},fragile,t]{Breaking the List}
 \begin{onlyenv}<1-2>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgf8e2521}]{What about the second rule?}
...
\begin{frame}[label={sec:org947bbda}]{There can be only one}
There is only one lawful implementation of Functor for a given type.
\end{frame}

\begin{frame}[label={sec:org9360cbe},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:orgc9ab593},fragile]{Outcome}
 \begin{itemize}
...
\label{sec:org973ed96}

\begin{frame}[label={sec:org0d436f0},fragile]{Next step}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:org6d969c8},fragile]{Next step}
 \begin{minted}[]{scala}
def apply :  (A => B) =>   A  =>   B
...
\begin{frame}[label={sec:org74bbdad},fragile]{Solution}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:orgcf064e3},fragile]{Following the same idea}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org461530e},fragile]{What's about pure?}
 \begin{columns}
...
\begin{frame}[label={sec:orgee95b29},fragile]{Another perspective}
...
\begin{frame}[label={sec:org366becb},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org4594a3a},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org47faa50},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org4d3193e},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgb537b24},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org4f18d47},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org73d5309},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{minted}[]{scala}
class MonoidalToApplicative[F[_]: Monoidal]() extends Applicative[F] {
  override def pure[A](a: A): F[A] = Monoidal[F].unit.fmap(_ => a)
...
\begin{frame}[label={sec:org4c687f5},fragile]{Monoid part of \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Monoid[A] {
...
\begin{frame}[label={sec:org942c8cf},fragile]{Applicative laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org34a151d},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org893a69c},fragile]{Outcome}
 \begin{itemize}
...
\section{Parsing}
\label{sec:orge7fafc3}

\begin{frame}[label={sec:org75b1e69},fragile,t]{Parsing}
 \vspace*{20px}
...
\begin{frame}[label={sec:org81dbda3},fragile,t]{Simple parser}
 \begin{minted}[]{scala}
case class Parser[A](parse: String => ParserResult[A])
\end{minted}
...
\begin{frame}[label={sec:org85f89d7},fragile]{Abstracting \texttt{char}}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgb50294a},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org08c5f3b},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgcc489bd},fragile,t]{(invalid) UUID parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orge9db045},fragile,t]{Space invaders}
 \begin{minted}[]{scala}
def uuid: Parser[String] = /* ... */
...
\begin{frame}[label={sec:org4588c52}]{So\ldots{}}
\begin{center}
\includegraphics[height=5cm]{images/applicative-confusion.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:org055bbe0},fragile,t]{Simple case class example}
 \begin{onlyenv}<1->
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgeae8347},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org2a59903}]{Outcome}
\begin{itemize}
...
\section{Validation}
\label{sec:org381b301}

\begin{frame}[label={sec:orgc420baf},fragile]{Validation}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org139043d},fragile]{Person}
 \begin{minted}[]{scala}
case class Person(name: String, age: Int)
\end{minted}
...
\begin{frame}[label={sec:orgdf06e86},fragile]{Person}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org2eda813},fragile]{Quest for 'all errors'}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org35251d9},fragile]{What's wrong with Either?}
...
\begin{frame}[label={sec:orgaa34b58},fragile]{Doing as much as we can}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org43948a4},fragile]{Coding time}
 \begin{itemize}
...
\section*{Final words}
\label{sec:org1250bba}
\begin{frame}[label={sec:org85cc550},fragile]{Recap}
 \begin{onlyenv}
\begin{itemize}
...
\section{Questions?}
\label{sec:org448efbe}

\section{Thank you very much!}
\label{sec:orge4d38e7}
\end{document}
