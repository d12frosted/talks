...
\section*{Intro}
\label{sec:org41257e9}
\begin{frame}[label={sec:orgdbc2ea1}]{About us}
\vspace*{20px}
...
\begin{frame}[label={sec:org119fb88}]{About the Forkshop}
\begin{itemize}
...
\begin{frame}[label={sec:org547e7fa},fragile]{Whys}
 \begin{itemize}
...
\section*{Today}
\label{sec:org25a3d1d}
\begin{frame}[label={sec:orgab99ea1}]{Agenda}
\begin{itemize}
...
\begin{frame}[label={sec:org4734d6d},fragile]{Before we start}
 \begin{minted}[]{bash}
...
\section{Type theory}
\label{sec:org7bd5436}
\begin{frame}[label={sec:org728082b}]{Values and types}
...
\begin{frame}[label={sec:org11df05c},fragile]{Nullary value constructors}
...
\begin{frame}[label={sec:orgda10bc3},fragile]{Unary value constructors: function}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgf122c8c},fragile]{Unary value constructors: class}
...
\begin{frame}[label={sec:org895ce57},fragile]{Higher arity}
...
\begin{frame}[label={sec:orgfc35dcb},fragile]{Nullary type constructors}
...
\begin{frame}[label={sec:org2324a12},fragile]{Unary type constructors}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org988d3b3},fragile]{Higher arity}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org67439bf},fragile]{Kinds}
...
\begin{frame}[label={sec:org4b8798f},fragile]{Examples}
 \begin{itemize}
...
\begin{frame}[label={sec:orgfb042ce},fragile]{Higher-order functions}
...
\begin{frame}[label={sec:orga54f2a2},fragile]{Higher-order types (1)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org261776b},fragile]{Higher-order types (2)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org88f91b0}]{Higher-order types (3)}
...
\begin{frame}[label={sec:orgb61b13c}]{The most important question}
\begin{center}
...
\section{Functor}
\label{sec:orged45a4c}
\begin{frame}[label={sec:org1dcf0f7}]{Function Application}
...
\begin{frame}[label={sec:org771913b},fragile]{Function Application}
...
\begin{frame}[label={sec:orga6a0862},fragile]{Function Application}
...
\begin{frame}[label={sec:orgfb50ed8},fragile]{Context: optional value}
...
\begin{frame}[label={sec:org02b9d19},fragile]{Context: optional value}
 \begin{itemize}
...
\begin{frame}[label={sec:orgaa54f0c},fragile]{Context: optional value}
 \begin{minted}[]{scala}
//  apply        : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:orgf81f19a},fragile]{Many contexts}
 \begin{itemize}
...
\begin{frame}[label={sec:orga304349},fragile]{Many applies}
 \begin{minted}[]{scala}
def apply           : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:org1b041c6}]{Repetition is}
\begin{center}
...
\begin{frame}[label={sec:org3376de8},fragile]{Functoriana}
 \begin{minted}[]{scala}
trait Functor[F[_]] {
...
\begin{frame}[label={sec:org6435cf4},fragile]{Code responsibly, know the laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org9c2b870}]{Sum type: Option}
\begin{center}
...
\begin{frame}[label={sec:org230d747},fragile]{Breaking the Option}
 \begin{minted}[]{scala}
  fmap(identity)(value)
= identity(value)
= value
...
\begin{frame}[label={sec:orgd34fd62},fragile]{Product type: List}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org988de3a},fragile,t]{Breaking the List}
 \begin{onlyenv}<1-2>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org2ffa79c}]{What about the second rule?}
...
\begin{frame}[label={sec:orgfe7af53},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:orgb811d69},fragile]{Outcome}
 \begin{itemize}
...
\label{sec:org784c4f7}

\begin{frame}[label={sec:org0050fc3},fragile]{Next step}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:org3fa5de3},fragile]{Next step}
 \begin{minted}[]{scala}
def apply :  (A => B) =>   A  =>   B
...
\begin{frame}[label={sec:orgcb56650},fragile]{Solution}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:orgfc2e357},fragile]{Following the same idea}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgd2d339b},fragile]{What's about pure?}
 \begin{columns}
...
\begin{frame}[label={sec:orgc66c141},fragile]{Another perspective}
...
\begin{frame}[label={sec:orgb12a339},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org3c65485},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgbccf4c4},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org3082f79},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org6031528},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org7ba5373},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orge7cc2eb},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{minted}[]{scala}
class MonoidalToApplicative[F[_]: Monoidal]() extends Applicative[F] {
  override def pure[A](a: A): F[A] = Monoidal[F].unit.fmap(_ => a)
...
\begin{frame}[label={sec:orgb8a332a},fragile]{Monoid part of \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Monoid[A] {
...
\begin{frame}[label={sec:org227751f},fragile]{Applicative laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org16120a5},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org5c9049a},fragile]{Outcome}
 \begin{itemize}
...
\section{Parsing}
\label{sec:orgb580394}

\begin{frame}[label={sec:orgc14cd7f},fragile,t]{Parsing}
 \vspace*{20px}
...
\begin{frame}[label={sec:orgc3390d5},fragile,t]{Simple parser}
 \vspace*{20px}
...
\begin{frame}[label={sec:org0d8c67e},fragile]{Abstracting \texttt{char}}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org913070b},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org11e7ea4},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org9ea946c},fragile,t]{(invalid) UUID parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgaff2751},fragile,t]{Space invaders}
 \begin{minted}[]{scala}
def uuid: Parser[String] = /* ... */
...
\begin{frame}[label={sec:org8ad113b}]{So\ldots{}}
\begin{center}
\includegraphics[height=5cm]{images/applicative-confusion.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:org3b1981a},fragile,t]{Simple case class example}
 \begin{onlyenv}<1->
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org40a3b56},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org6bdf0a1}]{Outcome}
\begin{itemize}
...
\section{Validation}
\label{sec:org4c3fe8e}

\begin{frame}[label={sec:orgba776aa},fragile]{Validation}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org2f5d54f},fragile]{Person}
 \begin{minted}[]{scala}
case class Person(name: String, age: Int)
\end{minted}
...
\begin{frame}[label={sec:org28c072f},fragile]{Person}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org66c0126},fragile]{Quest for 'all errors'}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orge267bc7},fragile]{What's wrong with Either?}
...
\begin{frame}[label={sec:org7979771},fragile]{Doing as much as we can}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgdaea08e},fragile]{Coding time}
 \begin{itemize}
...
\section*{Final words}
\label{sec:org07e010e}
\begin{frame}[label={sec:orgeda58ae},fragile]{Recap}
 \begin{onlyenv}
\begin{itemize}
...
\section{Questions?}
\label{sec:orgf765bd3}

\section{Thank you very much!}
\label{sec:orge9f1825}
\end{document}
