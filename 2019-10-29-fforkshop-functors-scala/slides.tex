...
\section*{Intro}
\label{sec:orgff4f339}
\begin{frame}[label={sec:orge9e0ab9}]{About us}
\vspace*{20px}
...
\begin{frame}[label={sec:org50e1bfd}]{About the Forkshop}
\begin{itemize}
...
\begin{frame}[label={sec:orgff4be68},fragile]{Whys}
 \begin{itemize}
...
\section*{Today}
\label{sec:org0538649}
\begin{frame}[label={sec:org1ec3479}]{Agenda}
\begin{itemize}
...
\begin{frame}[label={sec:org1817e5d},fragile]{Before we start}
 \begin{minted}[]{bash}
...
\section{Type theory}
\label{sec:org780cf61}
\begin{frame}[label={sec:orgcda3393}]{Values and types}
...
\begin{frame}[label={sec:orgf0aaebe},fragile]{Nullary value constructors}
...
\begin{frame}[label={sec:org86ac7ba},fragile]{Unary value constructors: function}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgff4874b},fragile]{Unary value constructors: class}
...
\begin{frame}[label={sec:org3fae358},fragile]{Higher arity}
...
\begin{frame}[label={sec:orgb4ee945},fragile]{Nullary type constructors}
...
\begin{frame}[label={sec:orga10ac1a},fragile]{Unary type constructors}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org35d8f3f},fragile]{Higher arity}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org9b043b2},fragile]{Kinds}
...
\begin{frame}[label={sec:org0f4712a},fragile]{Examples}
 \begin{itemize}
...
\begin{frame}[label={sec:orgac06772},fragile]{Higher-order functions}
...
\begin{frame}[label={sec:org2d4fae1},fragile]{Higher-order types (1)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgbe7801a},fragile]{Higher-order types (2)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org6d11094}]{Higher-order types (3)}
...
\begin{frame}[label={sec:org6d624ae}]{The most important question}
\begin{center}
...
\section{Functor}
\label{sec:orga72e501}
\begin{frame}[label={sec:orgc087537}]{Function Application}
...
\begin{frame}[label={sec:orgb40fe3a},fragile]{Function Application}
...
\begin{frame}[label={sec:orgae14423},fragile]{Function Application}
...
\begin{frame}[label={sec:org58e1e06},fragile]{Context: optional value}
...
\begin{frame}[label={sec:org98743b5},fragile]{Context: optional value}
 \begin{itemize}
...
\begin{frame}[label={sec:org5e8c6c2},fragile]{Context: optional value}
 \begin{minted}[]{scala}
//  apply        : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:orge9206e4},fragile]{Many contexts}
 \begin{itemize}
...
\begin{frame}[label={sec:org41d2625},fragile]{Many applies}
 \begin{minted}[]{scala}
def apply           : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:org0357255}]{Repetition is}
\begin{center}
...
\begin{frame}[label={sec:orgcacf363},fragile]{Functoriana}
 \begin{minted}[]{scala}
trait Functor[F[_]] {
...
\begin{frame}[label={sec:org0bfaed8},fragile]{Code responsibly, know the laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org6284f97}]{Sum type: Option}
\begin{center}
...
\begin{frame}[label={sec:org2e32d52},fragile]{Breaking the Option}
 \begin{minted}[]{scala}
  fmap(identity)(value)
= identity(value)
= value
...
\begin{frame}[label={sec:org591c860},fragile]{Product type: List}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgdd6dbc2},fragile,t]{Breaking the List}
 \begin{onlyenv}<1-2>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgba37f96}]{What about the second rule?}
...
\begin{frame}[label={sec:org59d7d09},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:orgb1b1768},fragile]{Outcome}
 \begin{itemize}
...
\label{sec:org9b36fc3}

\begin{frame}[label={sec:org3ae57ee},fragile]{Next step}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:orgbefbdba},fragile]{Next step}
 \begin{minted}[]{scala}
def apply :  (A => B) =>   A  =>   B
...
\begin{frame}[label={sec:org34499f1},fragile]{Solution}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:orgb87414a},fragile]{Following the same idea}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgba3cfc4},fragile]{What's about pure?}
 \begin{columns}
...
\begin{frame}[label={sec:org7a2a4ad},fragile]{Another perspective}
...
\begin{frame}[label={sec:org7a80660},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org58d126c},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgd10302c},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orga898317},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org2bf4495},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orge976f53},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org7193c81},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{minted}[]{scala}
class MonoidalToApplicative[F[_]: Monoidal]() extends Applicative[F] {
  override def pure[A](a: A): F[A] = Monoidal[F].unit.fmap(_ => a)
...
\begin{frame}[label={sec:org288a682},fragile]{Monoid part of \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Monoid[A] {
...
\begin{frame}[label={sec:org2d8d143},fragile]{Applicative laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org4d57436},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:orgc9dd9ec},fragile]{Outcome}
 \begin{itemize}
...
\section{Parsing}
\label{sec:orgfea39ce}

\begin{frame}[label={sec:org012a9a5},fragile,t]{Parsing}
 \vspace*{20px}
...
\begin{frame}[label={sec:orge09cc34},fragile,t]{Simple parser}
 \vspace*{20px}
...
\begin{frame}[label={sec:org28fe503},fragile]{Abstracting \texttt{char}}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org3229991},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgd2c6eba},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org6475dd3},fragile,t]{(invalid) UUID parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orga88eb1b},fragile,t]{Space invaders}
 \begin{minted}[]{scala}
def uuid: Parser[String] = /* ... */
...
\begin{frame}[label={sec:org28c36d2}]{So\ldots{}}
\begin{center}
\includegraphics[height=5cm]{images/applicative-confusion.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgc033016},fragile,t]{Simple case class example}
 \begin{onlyenv}<1->
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgbc32192},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org3fa1712}]{Outcome}
\begin{itemize}
...
\section{Validation}
\label{sec:org61c564f}

\begin{frame}[label={sec:org4004a92},fragile]{Validation}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org172a235},fragile]{Person}
 \begin{minted}[]{scala}
case class Person(name: String, age: Int)
\end{minted}
...
\begin{frame}[label={sec:org5a5675a},fragile]{Person}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org1fd92df},fragile]{Quest for 'all errors'}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org5939a27},fragile]{What's wrong with Either?}
...
\begin{frame}[label={sec:org8eeba4d},fragile]{Doing as much as we can}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org92cadde},fragile]{Coding time}
 \begin{itemize}
...
\section*{Final words}
\label{sec:orga0c5175}
\begin{frame}[label={sec:org4fc5b03},fragile]{Recap}
 \begin{onlyenv}
\begin{itemize}
...
\section{Questions?}
\label{sec:org8380eef}

\section{Thank you very much!}
\label{sec:org800e9e5}
\end{document}
