...
\section*{Intro}
\label{sec:org55dd964}
\begin{frame}[label={sec:orgfb9718e}]{About us}
\vspace*{20px}
...
\begin{frame}[label={sec:org5d99950}]{About the Forkshop}
\begin{itemize}
...
\begin{frame}[label={sec:orgcff5502},fragile]{Whys}
 \begin{itemize}
...
\section*{Today}
\label{sec:org89c90ef}
\begin{frame}[label={sec:org6a70704}]{Agenda}
\begin{itemize}
...
\begin{frame}[label={sec:orge9ab9eb},fragile]{Before we start}
 \begin{minted}[]{bash}
...
\section{Type theory}
\label{sec:org6d96481}
\begin{frame}[label={sec:org903924d}]{Values and types}
...
\begin{frame}[label={sec:org2d84d36},fragile]{Nullary value constructors}
...
\begin{frame}[label={sec:orgde0bc6b},fragile]{Unary value constructors: function}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgb198e10},fragile]{Unary value constructors: class}
...
\begin{frame}[label={sec:org7a97b18},fragile]{Higher arity}
...
\begin{frame}[label={sec:org216be3f},fragile]{Nullary type constructors}
...
\begin{frame}[label={sec:org26d77d6},fragile]{Unary type constructors}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org9ad28d1},fragile]{Higher arity}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgecf6ae5},fragile]{Kinds}
...
\begin{frame}[label={sec:org9d4b5b4},fragile]{Examples}
 \begin{itemize}
...
\begin{frame}[label={sec:org6a3f2bc},fragile]{Higher-order functions}
...
\begin{frame}[label={sec:orgd2a3322},fragile]{Higher-order types (1)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org7410bb8},fragile]{Higher-order types (2)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgf3403c1}]{Higher-order types (3)}
...
\begin{frame}[label={sec:org4a37280}]{The most important question}
\begin{center}
...
\section{Functor}
\label{sec:org783b50f}
\begin{frame}[label={sec:orge859e3b}]{Function Application}
...
\begin{frame}[label={sec:org03f2655},fragile]{Function Application}
...
\begin{frame}[label={sec:org888ec37},fragile]{Function Application}
...
\begin{frame}[label={sec:orgf6683c8},fragile]{Context: optional value}
...
\begin{frame}[label={sec:orgfbbc7a9},fragile]{Context: optional value}
 \begin{itemize}
...
\begin{frame}[label={sec:org1aef392},fragile]{Context: optional value}
 \begin{minted}[]{scala}
//  apply        : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:org7f703a2},fragile]{Many contexts}
 \begin{itemize}
...
\begin{frame}[label={sec:orgbba2c06},fragile]{Many applies}
 \begin{minted}[]{scala}
def apply           : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:org53ad085}]{Repetition is}
\begin{center}
...
\begin{frame}[label={sec:orgfc746f6},fragile]{Functoriana}
 \begin{minted}[]{scala}
trait Functor[F[_]] {
...
\begin{frame}[label={sec:orge4b686d},fragile]{Code responsibly, know the laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org7cc3b73}]{Sum type: Option}
\begin{center}
...
\begin{frame}[label={sec:org27427b6},fragile]{Breaking the Option}
 \begin{minted}[]{scala}
  fmap(identity)(value)
= identity(value)
= value
...
\begin{frame}[label={sec:org15f12f3},fragile]{Product type: List}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org198fcbd},fragile,t]{Breaking the List}
 \begin{onlyenv}<1-2>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org46a701e}]{What about the second rule?}
...
\begin{frame}[label={sec:org43a36b8}]{There can be only one}
There is only one lawful implementation of Functor for a given type.
\end{frame}

\begin{frame}[label={sec:org7437c9d},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org9c26ffb},fragile]{Outcome}
 \begin{itemize}
...
\label{sec:orga86c4b5}

\begin{frame}[label={sec:org1879b2f},fragile]{Next step}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:org4cb187f},fragile]{Next step}
 \begin{minted}[]{scala}
def apply :  (A => B) =>   A  =>   B
...
\begin{frame}[label={sec:orgf13556c},fragile]{Solution}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:orgaa12c8f},fragile]{Following the same idea}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org455ffe5},fragile]{What's about pure?}
 \begin{columns}
...
\begin{frame}[label={sec:orgd20e1a2},fragile]{Another perspective}
...
\begin{frame}[label={sec:org74b7a99},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orga992ef2},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org8f4ce83},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org2f05645},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgeba6d71},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org69ea9a4},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgfdd502c},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{minted}[]{scala}
class MonoidalToApplicative[F[_]: Monoidal]() extends Applicative[F] {
  override def pure[A](a: A): F[A] = Monoidal[F].unit.fmap(_ => a)
...
\begin{frame}[label={sec:orga3e049b},fragile]{Some symmetry}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org76267e1},fragile]{Monoid part of \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Monoid[A] {
...
\begin{frame}[label={sec:orgbf1a487},fragile]{Applicative laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org99b5e59},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org34c0c13},fragile]{Conditionals}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org9a5b82e},fragile]{Outcome}
 \begin{itemize}
...
\section{Parsing}
\label{sec:orga566f0d}

\begin{frame}[label={sec:org8753bc6},fragile,t]{Parsing}
 \vspace*{20px}
...
\begin{frame}[label={sec:org2c55a04},fragile,t]{Simple parser}
 \begin{minted}[]{scala}
case class Parser[A](parse: String => ParserResult[A])
\end{minted}
...
\begin{frame}[label={sec:orge870a67},fragile]{Abstracting \texttt{char}}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org517ec41},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgca228f8},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org44314b3},fragile,t]{(invalid) UUID parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org49c2869},fragile,t]{Space invaders}
 \begin{minted}[]{scala}
def uuid: Parser[String] = /* ... */
...
\begin{frame}[label={sec:org7798712}]{So\ldots{}}
\begin{center}
\includegraphics[height=5cm]{images/applicative-confusion.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:org8953b55},fragile,t]{Simple case class example}
 \begin{onlyenv}<1->
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org103f28a},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org885fd4d}]{Outcome}
\begin{itemize}
...
\section{Validation}
\label{sec:org7a67a13}

\begin{frame}[label={sec:orgf257252},fragile]{Validation}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org1e3cf93},fragile]{Person}
 \begin{minted}[]{scala}
case class Person(name: String, age: Int)
\end{minted}
...
\begin{frame}[label={sec:org70525a7},fragile]{Person}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org4dbfb1a},fragile]{Quest for 'all errors'}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org25cdd55},fragile]{What's wrong with Either?}
...
\begin{frame}[label={sec:orgf72b8b3},fragile]{Doing as much as we can}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org8ec97d1},fragile]{Coding time}
 \begin{itemize}
...
\section*{Final words}
\label{sec:orgcc6a891}
\begin{frame}[label={sec:org762f671},fragile]{Recap}
 \begin{onlyenv}
\begin{itemize}
...
\section*{References}
\label{sec:org73df24e}
\begin{frame}[label={sec:orgadef6af}]{References}
\begin{itemize}
...
\section{Questions?}
\label{sec:org0fbab49}

\section{Thank you very much!}
\label{sec:orgbe6e7ef}
\end{document}
