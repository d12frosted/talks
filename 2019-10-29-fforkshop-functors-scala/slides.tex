...
\section*{Intro}
\label{sec:orgfbd0b9d}
\begin{frame}[label={sec:orgf96c3b7}]{About us}
\vspace*{20px}
...
\begin{frame}[label={sec:org0a3070c}]{About the Forkshop}
\begin{itemize}
...
\begin{frame}[label={sec:org92990c6},fragile]{Whys}
 \begin{itemize}
...
\section*{Today}
\label{sec:org1a6ff38}
\begin{frame}[label={sec:orgee27086}]{Agenda}
\begin{itemize}
...
\begin{frame}[label={sec:orge4d3753},fragile]{Before we start}
 \begin{minted}[]{bash}
...
\section{Type theory}
\label{sec:org23bb96d}
\begin{frame}[label={sec:orgb0faef5}]{Values and types}
...
\begin{frame}[label={sec:orgae3477f},fragile]{Nullary value constructors}
...
\begin{frame}[label={sec:org092bdac},fragile]{Unary value constructors: function}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgaa19662},fragile]{Unary value constructors: class}
...
\begin{frame}[label={sec:orgb5dad1a},fragile]{Higher arity}
...
\begin{frame}[label={sec:org5e1232a},fragile]{Nullary type constructors}
...
\begin{frame}[label={sec:orgdc20b95},fragile]{Unary type constructors}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org56a63b1},fragile]{Higher arity}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgf49fe20},fragile]{Kinds}
...
\begin{frame}[label={sec:orga7c9d2a},fragile]{Examples}
 \begin{itemize}
...
\begin{frame}[label={sec:org5746279},fragile]{Higher-order functions}
...
\begin{frame}[label={sec:org4003852},fragile]{Higher-order types (1)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orge82aa9c},fragile]{Higher-order types (2)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org5f28fb6}]{Higher-order types (3)}
...
\begin{frame}[label={sec:org21f4b1b}]{The most important question}
\begin{center}
...
\section{Functor}
\label{sec:org6b4a0c8}
\begin{frame}[label={sec:org01422ef}]{Function Application}
...
\begin{frame}[label={sec:orga8ef4d5},fragile]{Function Application}
...
\begin{frame}[label={sec:orgeb9f32b},fragile]{Function Application}
...
\begin{frame}[label={sec:org70fd61e},fragile]{Context: optional value}
...
\begin{frame}[label={sec:orgd63a29e},fragile]{Context: optional value}
 \begin{itemize}
...
\begin{frame}[label={sec:orge0d27df},fragile]{Context: optional value}
 \begin{minted}[]{scala}
//  apply        : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:orgf9c7067},fragile]{Many contexts}
 \begin{itemize}
...
\begin{frame}[label={sec:org870500b},fragile]{Many applies}
 \begin{minted}[]{scala}
def apply           : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:org155b4b5}]{Repetition is}
\begin{center}
...
\begin{frame}[label={sec:org08d6b22},fragile]{Functoriana}
 \begin{minted}[]{scala}
trait Functor[F[_]] {
...
\begin{frame}[label={sec:org4a62e2c},fragile]{Code responsibly, know the laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org17bf1e9}]{Sum type: Option}
\begin{center}
...
\begin{frame}[label={sec:orgd2f7e41},fragile]{Breaking the Option}
 \begin{minted}[]{scala}
  fmap(identity)(value)
= identity(value)
= value
...
\begin{frame}[label={sec:org9762212},fragile]{Product type: List}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgbe1d9bd},fragile,t]{Breaking the List}
 \begin{onlyenv}<1-2>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orge5f4685}]{What about the second rule?}
...
\begin{frame}[label={sec:org1e5f284},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:orgd0b718a},fragile]{Outcome}
 \begin{itemize}
...
\label{sec:orgb7934c6}

\begin{frame}[label={sec:orgccc574c},fragile]{Next step}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:orga2ce86c},fragile]{Next step}
 \begin{minted}[]{scala}
def apply :  (A => B) =>   A  =>   B
...
\begin{frame}[label={sec:org89f6661},fragile]{Solution}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:orgce5e34b},fragile]{Following the same idea}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgb85fa42},fragile]{What's about pure?}
 \begin{enumerate}
...
\begin{frame}[label={sec:org3c13575},fragile]{Another perspective}
...
\begin{frame}[label={sec:orgbf9e81d},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org4bfe5cc},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orge9cd6c0},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org90f4179},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org1402232},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgea5b941},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org4ee17fb},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{minted}[]{scala}
class MonoidalToApplicative[F[_]: Monoidal]() extends Applicative[F] {
  override def pure[A](a: A): F[A] = Monoidal[F].unit.fmap(_ => a)
...
\begin{frame}[label={sec:org4d00729},fragile]{Monoid part of \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Monoid[A] {
...
\begin{frame}[label={sec:org3eb9d21},fragile]{Applicative laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org3e65a49},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org2086607},fragile]{Outcome}
 \begin{itemize}
...
\section{Parsing}
\label{sec:org31589a8}

\begin{frame}[label={sec:orgaa9f60b},fragile,t]{Parsing}
 \vspace*{20px}
...
\begin{frame}[label={sec:org93e964a},fragile,t]{Simple parser}
 \vspace*{20px}
...
\begin{frame}[label={sec:org39c8527},fragile]{Abstracting \texttt{char}}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orga6f9aa9},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org0f5ab83},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org228a342},fragile,t]{(invalid) UUID parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgae009f1},fragile,t]{Space invaders}
 \begin{minted}[]{scala}
def uuid: Parser[String] = /* ... */
...
\begin{frame}[label={sec:org2211813}]{So\ldots{}}
\begin{center}
\includegraphics[height=5cm]{images/applicative-confusion.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgbeb9398},fragile,t]{Simple case class example}
 \begin{onlyenv}<1->
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org3ffb292},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org25c4b0c}]{Outcome}
\begin{itemize}
...
\section{Validation}
\label{sec:org99adc86}

\begin{frame}[label={sec:org6932bbd},fragile]{Validation}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org2cc8482},fragile]{Person}
 \begin{minted}[]{scala}
case class Person(name: String, age: Int)
\end{minted}
...
\begin{frame}[label={sec:org7efbde3},fragile]{Person}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orge1041f6},fragile]{Quest for 'all errors'}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org02bf25c},fragile]{What's wrong with Either?}
...
\begin{frame}[label={sec:org1b9d25f},fragile]{Doing as much as we can}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orge2ff957},fragile]{Coding time}
 \begin{itemize}
...
\section*{Final words}
\label{sec:orgbf92e1a}
\begin{frame}[label={sec:org8650371},fragile]{Recap}
 \begin{itemize}
...
\section{Questions?}
\label{sec:orgea2fed3}

\section{Thank you very much!}
\label{sec:orgce51003}
\end{document}
