...
\section*{Intro}
\label{sec:org02fa6d8}
\begin{frame}[label={sec:orgb11bd63}]{About us}
\vspace*{20px}
...
\begin{frame}[label={sec:orgecd3b3d}]{About the Forkshop}
\begin{itemize}
...
\begin{frame}[label={sec:org40ccbe9},fragile]{Whys}
 \begin{itemize}
...
\section*{Today}
\label{sec:orge919bc4}
\begin{frame}[label={sec:orgcfa761b}]{Agenda}
\begin{itemize}
...
\begin{frame}[label={sec:org2887a0a},fragile]{Before we start}
 \begin{minted}[]{bash}
...
\section{Type theory}
\label{sec:org2c1f4c2}
\begin{frame}[label={sec:orgfae7d0b}]{Values and types}
...
\begin{frame}[label={sec:org4819478},fragile]{Nullary value constructors}
...
\begin{frame}[label={sec:org1eb0dde},fragile]{Unary value constructors: function}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgadcfae8},fragile]{Unary value constructors: class}
...
\begin{frame}[label={sec:orgfd202f1},fragile]{Higher arity}
...
\begin{frame}[label={sec:org692985e},fragile]{Nullary type constructors}
...
\begin{frame}[label={sec:org8d6a5f4},fragile]{Unary type constructors}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org6202603},fragile]{Higher arity}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org9e28ea9},fragile]{Kinds}
...
\begin{frame}[label={sec:orged88b0e},fragile]{Examples}
 \begin{itemize}
...
\begin{frame}[label={sec:org5003fd6},fragile]{Higher-order functions}
...
\begin{frame}[label={sec:org5e12948},fragile]{Higher-order types (1)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org4c4983c},fragile]{Higher-order types (2)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org2407291}]{Higher-order types (3)}
...
\begin{frame}[label={sec:orge1713db}]{The most important question}
\begin{center}
...
\section{Functor}
\label{sec:org7f165ed}
\begin{frame}[label={sec:org3bd60ad}]{Function Application}
...
\begin{frame}[label={sec:org377209f},fragile]{Function Application}
...
\begin{frame}[label={sec:orge086bca},fragile]{Function Application}
...
\begin{frame}[label={sec:org9a13157},fragile]{Context: optional value}
...
\begin{frame}[label={sec:org43efece},fragile]{Context: optional value}
 \begin{itemize}
...
\begin{frame}[label={sec:org6d9bf66},fragile]{Context: optional value}
 \begin{minted}[]{scala}
//  apply        : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:org87e98fe},fragile]{Many contexts}
 \begin{itemize}
...
\begin{frame}[label={sec:org0365837},fragile]{Many applies}
 \begin{minted}[]{scala}
def apply           : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:orgf292d97}]{Repetition is}
\begin{center}
...
\begin{frame}[label={sec:org0b6e46b},fragile]{Functoriana}
 \begin{minted}[]{scala}
trait Functor[F[_]] {
...
\begin{frame}[label={sec:orgfaaf5a8},fragile]{Code responsibly, know the laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org900a899}]{Sum type: Option}
\begin{center}
...
\begin{frame}[label={sec:org9fe847f},fragile]{Breaking the Option}
 \begin{minted}[]{scala}
  fmap(identity)(value)
= identity(value)
= value
...
\begin{frame}[label={sec:org4974ada},fragile]{Product type: List}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org017e07b},fragile,t]{Breaking the List}
 \begin{onlyenv}<1-2>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgddb407c}]{What about the second rule?}
...
\begin{frame}[label={sec:org594dcc2}]{There can be only one}
There is only one lawful implementation of Functor for a given type.
\end{frame}

\begin{frame}[label={sec:org074bdff},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:orgbe9cd07},fragile]{Outcome}
 \begin{itemize}
...
\label{sec:orga5358e2}

\begin{frame}[label={sec:orgdc874e9},fragile]{Next step}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:org86ac5c3},fragile]{Next step}
 \begin{minted}[]{scala}
def apply :  (A => B) =>   A  =>   B
...
\begin{frame}[label={sec:org3c0a4f4},fragile]{Solution}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:org694aa6a},fragile]{Following the same idea}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org6ea7862},fragile]{What's about pure?}
 \begin{columns}
...
\begin{frame}[label={sec:org9f256ff},fragile]{Another perspective}
...
\begin{frame}[label={sec:org540dcb0},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org2798aee},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org4d27230},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgf7635de},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org8e0ff90},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org46af746},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org680fdf7},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{minted}[]{scala}
class MonoidalToApplicative[F[_]: Monoidal]() extends Applicative[F] {
  override def pure[A](a: A): F[A] = Monoidal[F].unit.fmap(_ => a)
...
\begin{frame}[label={sec:org4722d72},fragile]{Some symmetry}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgce4a9ee},fragile]{Monoid part of \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Monoid[A] {
...
\begin{frame}[label={sec:org0399879},fragile]{Applicative laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org84f369e},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:orgdead8e7},fragile]{Conditionals}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org0574ba4},fragile]{Outcome}
 \begin{itemize}
...
\section{Parsing}
\label{sec:orga450f7f}

\begin{frame}[label={sec:org0a87956},fragile,t]{Parsing}
 \vspace*{20px}
...
\begin{frame}[label={sec:org78366c2},fragile,t]{Simple parser}
 \begin{minted}[]{scala}
case class Parser[A](parse: String => ParserResult[A])
\end{minted}
...
\begin{frame}[label={sec:org46f5d33},fragile]{Abstracting \texttt{char}}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgf261caf},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgdafadec},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org52c5ba8},fragile,t]{(invalid) UUID parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org9119d75},fragile,t]{Space invaders}
 \begin{minted}[]{scala}
def uuid: Parser[String] = /* ... */
...
\begin{frame}[label={sec:org29ab1c3}]{So\ldots{}}
\begin{center}
\includegraphics[height=5cm]{images/applicative-confusion.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgb7cca61},fragile,t]{Simple case class example}
 \begin{onlyenv}<1->
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgd29f71b},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org30fec83}]{Outcome}
\begin{itemize}
...
\section{Validation}
\label{sec:org7498782}

\begin{frame}[label={sec:org535612b},fragile]{Validation}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org2d19e66},fragile]{Person}
 \begin{minted}[]{scala}
case class Person(name: String, age: Int)
\end{minted}
...
\begin{frame}[label={sec:org8a7fcc4},fragile]{Person}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org97ac402},fragile]{Quest for 'all errors'}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgb48c9ac},fragile]{What's wrong with Either?}
...
\begin{frame}[label={sec:orgb37e161},fragile]{Doing as much as we can}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orga518224},fragile]{Coding time}
 \begin{itemize}
...
\section*{Final words}
\label{sec:org80e75b5}
\begin{frame}[label={sec:org88d24c8},fragile]{Recap}
 \begin{onlyenv}
\begin{itemize}
...
\section*{References}
\label{sec:org05adfe8}
\begin{frame}[label={sec:orgd382930}]{References}
\begin{itemize}
...
\section{Questions?}
\label{sec:org9b3f75d}

\section{Thank you very much!}
\label{sec:orgc450eb3}
\end{document}
