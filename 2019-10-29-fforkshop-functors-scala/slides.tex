...
\section*{Intro}
\label{sec:orgeef810e}
\begin{frame}[label={sec:orgfb22489}]{About us}
\vspace*{20px}
...
\begin{frame}[label={sec:orgffe321b}]{About the Forkshop}
\begin{itemize}
...
\begin{frame}[label={sec:orgcd0a56c},fragile]{Whys}
 \begin{itemize}
...
\section*{Today}
\label{sec:orgc338a1c}
\begin{frame}[label={sec:org0d7ecf0}]{Agenda}
\begin{itemize}
...
\begin{frame}[label={sec:orga5e1cd7},fragile]{Before we start}
 \begin{minted}[]{bash}
...
\section{Type theory}
\label{sec:org5324109}
\begin{frame}[label={sec:org6b72736}]{Values and types}
...
\begin{frame}[label={sec:org79314ef},fragile]{Nullary value constructors}
...
\begin{frame}[label={sec:org9bf20e0},fragile]{Unary value constructors: function}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org5937c4d},fragile]{Unary value constructors: class}
...
\begin{frame}[label={sec:orgf203d9d},fragile]{Higher arity}
...
\begin{frame}[label={sec:org2ab4370},fragile]{Nullary type constructors}
...
\begin{frame}[label={sec:orga7d82f8},fragile]{Unary type constructors}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org6fc551f},fragile]{Higher arity}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org9248cd4},fragile]{Kinds}
...
\begin{frame}[label={sec:org6e5d034},fragile]{Examples}
 \begin{itemize}
...
\begin{frame}[label={sec:org4343300},fragile]{Higher-order functions}
...
\begin{frame}[label={sec:org904ad1d},fragile]{Higher-order types (1)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgfc8c7b2},fragile]{Higher-order types (2)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org56641e8}]{Higher-order types (3)}
...
\begin{frame}[label={sec:org49a52d7}]{The most important question}
\begin{center}
...
\section{Functor}
\label{sec:orgd1ab0e4}
\begin{frame}[label={sec:orgdcb3b79}]{Function Application}
...
\begin{frame}[label={sec:org81d8d86},fragile]{Function Application}
...
\begin{frame}[label={sec:org983e487},fragile]{Function Application}
...
\begin{frame}[label={sec:org1f4ebbd},fragile]{Context: optional value}
...
\begin{frame}[label={sec:orgf00b677},fragile]{Context: optional value}
 \begin{itemize}
...
\begin{frame}[label={sec:org9e6d467},fragile]{Context: optional value}
 \begin{minted}[]{scala}
//  apply        : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:org7daeb96},fragile]{Many contexts}
 \begin{itemize}
...
\begin{frame}[label={sec:org275d066},fragile]{Many applies}
 \begin{minted}[]{scala}
def apply           : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:orgfb9367e}]{Repetition is}
\begin{center}
...
\begin{frame}[label={sec:org9aca36e},fragile]{Functoriana}
 \begin{minted}[]{scala}
trait Functor[F[_]] {
...
\begin{frame}[label={sec:org498b697},fragile]{Code responsibly, know the laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org863bd7c}]{Sum type: Option}
\begin{center}
...
\begin{frame}[label={sec:orgd11daa8},fragile]{Breaking the first rule}
 \begin{minted}[]{scala}
  fmap(identity)(value)
= identity(value)
= value
...
\begin{frame}[label={sec:org21f74c3},fragile]{Product type: List}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org5039e2f}]{Breaking the second rule}
...
\begin{frame}[label={sec:orgc711670},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:orge5bef70},fragile]{Outcome}
 \begin{itemize}
...
\label{sec:org780c04d}

\begin{frame}[label={sec:org3d94d51},fragile]{Next step}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:org23c20a0},fragile]{Next step}
 \begin{minted}[]{scala}
def apply :  (A => B) =>   A  =>   B
...
\begin{frame}[label={sec:org39bc3e9},fragile]{Solution}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:org55c7f24},fragile]{Following the same idea}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org734ddec},fragile]{What's about pure?}
 \begin{enumerate}
...
\begin{frame}[label={sec:org22ab0a1},fragile]{Another perspective}
...
\begin{frame}[label={sec:org36cee0c},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org396aa38},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orge6c98b2},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org1ab499f},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org488b329},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org5b21ed9},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgea5a53e},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{minted}[]{scala}
class MonoidalToApplicative[F[_]: Monoidal]() extends Applicative[F] {
  override def pure[A](a: A): F[A] = Monoidal[F].unit.fmap(_ => a)
...
\begin{frame}[label={sec:org6f4be04},fragile]{Monoid part of \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Monoid[A] {
...
\begin{frame}[label={sec:orgc12bc4f},fragile]{Applicative laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org1553ed4},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org9472c2e},fragile]{Outcome}
 \begin{itemize}
...
\section{Parsing}
\label{sec:orgc628c87}

\begin{frame}[label={sec:org5292a5d},fragile,t]{Parsing}
 \vspace*{20px}
...
\begin{frame}[label={sec:org8931f24},fragile,t]{Simple parser}
 \vspace*{20px}
...
\begin{frame}[label={sec:orga87e33a},fragile]{Abstracting \texttt{char}}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org679d93d},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org2e45347},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgbac7cb6},fragile,t]{(invalid) UUID parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org7948829},fragile,t]{Space invaders}
 \begin{minted}[]{scala}
def uuid: Parser[String] = /* ... */
...
\begin{frame}[label={sec:org51cd4da}]{So\ldots{}}
\begin{center}
\includegraphics[height=5cm]{images/applicative-confusion.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:org98aeedd},fragile,t]{Simple case class example}
 \begin{onlyenv}<1->
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgca32052},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org8e128b7}]{Outcome}
\begin{itemize}
...
\section{Validation}
\label{sec:org9aeac43}

\begin{frame}[label={sec:org4327489},fragile]{Validation}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org11a9703},fragile]{Person}
 \begin{minted}[]{scala}
case class Person(name: String, age: Int)
\end{minted}
...
\begin{frame}[label={sec:org1308a88},fragile]{Person}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org527b31c},fragile]{Quest for 'all errors'}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org74d6db3},fragile]{What's wrong with Either?}
...
\begin{frame}[label={sec:org2d6aabe},fragile]{Doing as much as we can}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org628af75},fragile]{Coding time}
 \begin{itemize}
...
\section*{Final words}
\label{sec:org8cc9e34}
\begin{frame}[label={sec:orge73bdcc},fragile]{Recap}
 \begin{itemize}
...
\section{Questions?}
\label{sec:orgf5da471}

\section{Thank you very much!}
\label{sec:org9721fdc}
\end{document}
