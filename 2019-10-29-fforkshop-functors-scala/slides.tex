...
\section*{Intro}
\label{sec:org364ea35}
\begin{frame}[label={sec:orgafac5b9}]{About us}
\vspace*{20px}
...
\begin{frame}[label={sec:org85e6864}]{About the Forkshop}
\begin{itemize}
...
\begin{frame}[label={sec:org7214378},fragile]{Whys}
 \begin{itemize}
...
\section*{Today}
\label{sec:org22b88ac}
\begin{frame}[label={sec:orgd0faa56}]{Agenda}
\begin{itemize}
...
\begin{frame}[label={sec:org4fb3e62},fragile]{Before we start}
 \begin{minted}[]{bash}
...
\section{Type theory}
\label{sec:orgb797135}
\begin{frame}[label={sec:org7ccf364}]{Values and types}
...
\begin{frame}[label={sec:org9612a04},fragile]{Nullary value constructors}
...
\begin{frame}[label={sec:org4b7e960},fragile]{Unary value constructors: function}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgfe7f5ea},fragile]{Unary value constructors: class}
...
\begin{frame}[label={sec:org76027b5},fragile]{Higher arity}
...
\begin{frame}[label={sec:org83b4992},fragile]{Nullary type constructors}
...
\begin{frame}[label={sec:orge5d2c98},fragile]{Unary type constructors}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org8ba0837},fragile]{Higher arity}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org0f5694b},fragile]{Kinds}
...
\begin{frame}[label={sec:org91268dc},fragile]{Examples}
 \begin{itemize}
...
\begin{frame}[label={sec:org784d389},fragile]{Higher-order functions}
...
\begin{frame}[label={sec:orge0e9393},fragile]{Higher-order types (1)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org1a37eb8},fragile]{Higher-order types (2)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org8f61b63}]{Higher-order types (3)}
...
\begin{frame}[label={sec:org9a6d3b3}]{The most important question}
\begin{center}
...
\section{Functor}
\label{sec:orgbe16a0e}
\begin{frame}[label={sec:org1b28d47}]{Function Application}
...
\begin{frame}[label={sec:orga380819},fragile]{Function Application}
...
\begin{frame}[label={sec:org67f2e7c},fragile]{Function Application}
...
\begin{frame}[label={sec:orgcc8974d},fragile]{Context: optional value}
...
\begin{frame}[label={sec:org9630f98},fragile]{Context: optional value}
 \begin{itemize}
...
\begin{frame}[label={sec:orgae4ea8d},fragile]{Context: optional value}
 \begin{minted}[]{scala}
//  apply        : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:org88cdd59},fragile]{Many contexts}
 \begin{itemize}
...
\begin{frame}[label={sec:orgc26add8},fragile]{Many applies}
 \begin{minted}[]{scala}
def apply           : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:org1120a9b}]{Repetition is}
\begin{center}
...
\begin{frame}[label={sec:org3e06cf1},fragile]{Functoriana}
 \begin{minted}[]{scala}
trait Functor[F[_]] {
...
\begin{frame}[label={sec:org32f275b},fragile]{Code responsibly, know the laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org6939d51}]{Sum type: Option}
\begin{center}
...
\begin{frame}[label={sec:org00e118c},fragile]{Breaking the Option}
 \begin{minted}[]{scala}
  fmap(identity)(value)
= identity(value)
= value
...
\begin{frame}[label={sec:org1baf046},fragile]{Product type: List}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org8d40a63},fragile,t]{Breaking the List}
 \begin{onlyenv}<1-2>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org60abed6}]{What about the second rule?}
...
\begin{frame}[label={sec:org73939ef}]{There can be only one}
There is only one lawful implementation of Functor for a given type.
\end{frame}

\begin{frame}[label={sec:orgf6a5cdc},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org29d450f},fragile]{Outcome}
 \begin{itemize}
...
\label{sec:org5d574fb}

\begin{frame}[label={sec:orgc6ef85d},fragile]{Next step}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:org386d6d2},fragile]{Next step}
 \begin{minted}[]{scala}
def apply :  (A => B) =>   A  =>   B
...
\begin{frame}[label={sec:org53031c5},fragile]{Solution}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:orgd6c59ab},fragile]{Following the same idea}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgfcd0bfb},fragile]{What's about pure?}
 \begin{columns}
...
\begin{frame}[label={sec:org6303492},fragile]{Another perspective}
...
\begin{frame}[label={sec:org322072a},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgab7e407},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org92fed77},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgbc45ee3},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgda47ebf},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org93fd636},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org0111ae3},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{minted}[]{scala}
class MonoidalToApplicative[F[_]: Monoidal]() extends Applicative[F] {
  override def pure[A](a: A): F[A] = Monoidal[F].unit.fmap(_ => a)
...
\begin{frame}[label={sec:org9412ca3},fragile]{Monoid part of \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Monoid[A] {
...
\begin{frame}[label={sec:org2b578de},fragile]{Applicative laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:orge38a0a5},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org465de13},fragile]{Outcome}
 \begin{itemize}
...
\section{Parsing}
\label{sec:org6768ec6}

\begin{frame}[label={sec:org739a088},fragile,t]{Parsing}
 \vspace*{20px}
...
\begin{frame}[label={sec:orgf71e525},fragile,t]{Simple parser}
 \begin{minted}[]{scala}
case class Parser[A](parse: String => ParserResult[A])
\end{minted}
...
\begin{frame}[label={sec:orgd5d5b4b},fragile]{Abstracting \texttt{char}}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgaf85158},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgbe54dc8},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org511d88f},fragile,t]{(invalid) UUID parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org3bb5f2c},fragile,t]{Space invaders}
 \begin{minted}[]{scala}
def uuid: Parser[String] = /* ... */
...
\begin{frame}[label={sec:org46eb74e}]{So\ldots{}}
\begin{center}
\includegraphics[height=5cm]{images/applicative-confusion.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:org3959f9f},fragile,t]{Simple case class example}
 \begin{onlyenv}<1->
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org90adf9f},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org379f9e3}]{Outcome}
\begin{itemize}
...
\section{Validation}
\label{sec:orga103db4}

\begin{frame}[label={sec:org7a80d64},fragile]{Validation}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgd5df7bf},fragile]{Person}
 \begin{minted}[]{scala}
case class Person(name: String, age: Int)
\end{minted}
...
\begin{frame}[label={sec:org58eb8c7},fragile]{Person}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org5eec09c},fragile]{Quest for 'all errors'}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org738afcd},fragile]{What's wrong with Either?}
...
\begin{frame}[label={sec:org3b74eb8},fragile]{Doing as much as we can}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgd52f226},fragile]{Coding time}
 \begin{itemize}
...
\section*{Final words}
\label{sec:org6884bad}
\begin{frame}[label={sec:org07fc05d},fragile]{Recap}
 \begin{onlyenv}
\begin{itemize}
...
\section{Questions?}
\label{sec:orgefa931f}

\section{Thank you very much!}
\label{sec:org00a0033}
\end{document}
