...
\section*{Intro}
\label{sec:org17121d2}
\begin{frame}[label={sec:org48368e7}]{About us}
\vspace*{20px}
...
\begin{frame}[label={sec:org1cf40d5}]{About the Forkshop}
\begin{itemize}
...
\begin{frame}[label={sec:org7c42d5a},fragile]{Whys}
 \begin{itemize}
...
\section*{Today}
\label{sec:org11c0da8}
\begin{frame}[label={sec:orge56f910}]{Agenda}
\begin{itemize}
...
\begin{frame}[label={sec:org13c5f43},fragile]{Before we start}
 \begin{minted}[]{bash}
...
\section{Type theory}
\label{sec:org5799091}
\begin{frame}[label={sec:org9abce30}]{Values and types}
...
\begin{frame}[label={sec:orgcd29024},fragile]{Nullary value constructors}
...
\begin{frame}[label={sec:org830e8b2},fragile]{Unary value constructors: function}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org32809ae},fragile]{Unary value constructors: class}
...
\begin{frame}[label={sec:org3ab063e},fragile]{Higher arity}
...
\begin{frame}[label={sec:org7af9256},fragile]{Nullary type constructors}
...
\begin{frame}[label={sec:org7eb61bc},fragile]{Unary type constructors}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org14741f5},fragile]{Higher arity}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgac83942},fragile]{Kinds}
...
\begin{frame}[label={sec:org5eedf42},fragile]{Examples}
 \begin{itemize}
...
\begin{frame}[label={sec:orgc86b164},fragile]{Higher-order functions}
...
\begin{frame}[label={sec:org89e9f49},fragile]{Higher-order types (1)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgd5f6f7a},fragile]{Higher-order types (2)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org147a9be}]{Higher-order types (3)}
...
\begin{frame}[label={sec:orgbb2d66d}]{The most important question}
\begin{center}
...
\section{Functor}
\label{sec:org76bfdbd}
\begin{frame}[label={sec:orgf365081}]{Function Application}
...
\begin{frame}[label={sec:orgda1d32c},fragile]{Function Application}
...
\begin{frame}[label={sec:orgf85061d},fragile]{Function Application}
...
\begin{frame}[label={sec:orge06f022},fragile]{Context: optional value}
...
\begin{frame}[label={sec:org7bd047d},fragile]{Context: optional value}
 \begin{itemize}
...
\begin{frame}[label={sec:orgfeae41f},fragile]{Context: optional value}
 \begin{minted}[]{scala}
//  apply        : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:org2a01cf0},fragile]{Many contexts}
 \begin{itemize}
...
\begin{frame}[label={sec:orgf9a307c},fragile]{Many applies}
 \begin{minted}[]{scala}
def apply           : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:org9e89c4e}]{Repetition is}
\begin{center}
...
\begin{frame}[label={sec:orgd8b3abd},fragile]{Functoriana}
 \begin{minted}[]{scala}
trait Functor[F[_]] {
...
\begin{frame}[label={sec:org403b6f9},fragile]{Code responsibly, know the laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org1bd425a}]{Sum type: Option}
\begin{center}
...
\begin{frame}[label={sec:org94a8305},fragile]{Breaking the Option}
 \begin{minted}[]{scala}
  fmap(identity)(value)
= identity(value)
= value
...
\begin{frame}[label={sec:org984356c},fragile]{Product type: List}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgce604bf},fragile,t]{Breaking the List}
 \begin{onlyenv}<1-2>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org70fa52e}]{What about the second rule?}
...
\begin{frame}[label={sec:orgd024665},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org21e5307},fragile]{Outcome}
 \begin{itemize}
...
\label{sec:org2a9152f}

\begin{frame}[label={sec:org2f7d87e},fragile]{Next step}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:org59f6093},fragile]{Next step}
 \begin{minted}[]{scala}
def apply :  (A => B) =>   A  =>   B
...
\begin{frame}[label={sec:orgee5ab0b},fragile]{Solution}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:orgb8951ad},fragile]{Following the same idea}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org1b2869f},fragile]{What's about pure?}
 \begin{enumerate}
...
\begin{frame}[label={sec:org9ad9496},fragile]{Another perspective}
...
\begin{frame}[label={sec:orgace284e},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgc0a022d},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org495931f},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgfc20404},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgb1bda39},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org3a54f55},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org9985b57},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{minted}[]{scala}
class MonoidalToApplicative[F[_]: Monoidal]() extends Applicative[F] {
  override def pure[A](a: A): F[A] = Monoidal[F].unit.fmap(_ => a)
...
\begin{frame}[label={sec:orge90452a},fragile]{Monoid part of \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Monoid[A] {
...
\begin{frame}[label={sec:org7644168},fragile]{Applicative laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:orgf620164},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:orga7aba23},fragile]{Outcome}
 \begin{itemize}
...
\section{Parsing}
\label{sec:orga8f3728}

\begin{frame}[label={sec:org0d14ad0},fragile,t]{Parsing}
 \vspace*{20px}
...
\begin{frame}[label={sec:org3ed1037},fragile,t]{Simple parser}
 \vspace*{20px}
...
\begin{frame}[label={sec:orgc5213d0},fragile]{Abstracting \texttt{char}}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org62b428c},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgcaccafd},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org8278d2a},fragile,t]{(invalid) UUID parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgf6df869},fragile,t]{Space invaders}
 \begin{minted}[]{scala}
def uuid: Parser[String] = /* ... */
...
\begin{frame}[label={sec:org90029d0}]{So\ldots{}}
\begin{center}
\includegraphics[height=5cm]{images/applicative-confusion.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:org681b89e},fragile,t]{Simple case class example}
 \begin{onlyenv}<1->
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org985f780},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:orgbf832f6}]{Outcome}
\begin{itemize}
...
\section{Validation}
\label{sec:orgf4c8757}

\begin{frame}[label={sec:org41d6fe9},fragile]{Validation}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org5e4a8ab},fragile]{Person}
 \begin{minted}[]{scala}
case class Person(name: String, age: Int)
\end{minted}
...
\begin{frame}[label={sec:orgbd6d313},fragile]{Person}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orge0b549e},fragile]{Quest for 'all errors'}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgc8ad23d},fragile]{What's wrong with Either?}
...
\begin{frame}[label={sec:orgf8b461d},fragile]{Doing as much as we can}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgdbb6061},fragile]{Coding time}
 \begin{itemize}
...
\section*{Final words}
\label{sec:org0142006}
\begin{frame}[label={sec:orgf7d4937},fragile]{Recap}
 \begin{itemize}
...
\section{Questions?}
\label{sec:orgec994f7}

\section{Thank you very much!}
\label{sec:org2bd33e9}
\end{document}
