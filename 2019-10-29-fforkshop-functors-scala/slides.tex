...
\section*{Intro}
\label{sec:org62f2218}
\begin{frame}[label={sec:org5068578}]{About us}
\vspace*{20px}
...
\begin{frame}[label={sec:orgb2f55c4}]{About the Forkshop}
\begin{itemize}
...
\begin{frame}[label={sec:orgce6e1d3},fragile]{Whys}
 \begin{itemize}
...
\section*{Today}
\label{sec:org52cfa6e}
\begin{frame}[label={sec:org1a90dc6}]{Agenda}
\begin{itemize}
...
\begin{frame}[label={sec:orgb719cea},fragile]{Before we start}
 \begin{minted}[]{bash}
...
\section{Type theory}
\label{sec:org73dca82}
\begin{frame}[label={sec:org85a8511}]{Values and types}
...
\begin{frame}[label={sec:org77416d9},fragile]{Nullary value constructors}
...
\begin{frame}[label={sec:org0506cd1},fragile]{Unary value constructors: function}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org3b0f098},fragile]{Unary value constructors: class}
...
\begin{frame}[label={sec:orgddc2abf},fragile]{Higher arity}
...
\begin{frame}[label={sec:org377ddd4},fragile]{Nullary type constructors}
...
\begin{frame}[label={sec:orga9cb52f},fragile]{Unary type constructors}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgf22969d},fragile]{Higher arity}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org3044ac5},fragile]{Kinds}
...
\begin{frame}[label={sec:org08452a1},fragile]{Examples}
 \begin{itemize}
...
\begin{frame}[label={sec:orgb95a5b7},fragile]{Higher-order functions}
...
\begin{frame}[label={sec:org1e4b7ef},fragile]{Higher-order types (1)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org9398ad6},fragile]{Higher-order types (2)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org1334a1c}]{Higher-order types (3)}
...
\begin{frame}[label={sec:org4e22451}]{The most important question}
\begin{center}
...
\section{Functor}
\label{sec:orgbe1d866}
\begin{frame}[label={sec:org2f1b00a}]{Function Application}
...
\begin{frame}[label={sec:orge19af0c},fragile]{Function Application}
...
\begin{frame}[label={sec:org32d37b8},fragile]{Function Application}
...
\begin{frame}[label={sec:orgf793e57},fragile]{Context: optional value}
...
\begin{frame}[label={sec:org38b6bfa},fragile]{Context: optional value}
 \begin{itemize}
...
\begin{frame}[label={sec:orgdb37a29},fragile]{Context: optional value}
 \begin{minted}[]{scala}
//  apply        : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:org44ea5f6},fragile]{Many contexts}
 \begin{itemize}
...
\begin{frame}[label={sec:org00d05f0},fragile]{Many applies}
 \begin{minted}[]{scala}
def apply           : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:orga282e44}]{Repetition is}
\begin{center}
...
\begin{frame}[label={sec:org1556d5a},fragile]{Functoriana}
 \begin{minted}[]{scala}
trait Functor[F[_]] {
...
\begin{frame}[label={sec:org34b8e24},fragile]{Product type: List}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org380e467}]{What about the second rule?}
...
\begin{frame}[label={sec:org2533b3f}]{There can be only one}
There is only one lawful implementation of Functor for a given type.
\end{frame}

\begin{frame}[label={sec:org71bc97f},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:orgc013fe7},fragile]{Outcome}
 \begin{itemize}
...
\label{sec:org9a35a90}

\begin{frame}[label={sec:orga9e681d},fragile]{Next step}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:org18ee1a4},fragile]{Next step}
 \begin{minted}[]{scala}
def apply :  (A => B) =>   A  =>   B
...
\begin{frame}[label={sec:orgeabfe4a},fragile]{Solution}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:org17d2622},fragile]{Following the same idea}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org17078e5},fragile]{What's about pure?}
 \begin{columns}
...
\begin{frame}[label={sec:org2099808},fragile]{Another perspective}
...
\begin{frame}[label={sec:org1be84d6},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org2a940d9},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org5d4f873},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org9352681},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgb3112ac},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org4e592ca},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org20d4cd7},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{minted}[]{scala}
class MonoidalToApplicative[F[_]: Monoidal]() extends Applicative[F] {
  override def pure[A](a: A): F[A] = Monoidal[F].unit.fmap(_ => a)
...
\begin{frame}[label={sec:org9b8d0f1},fragile]{Monoid part of \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Monoid[A] {
...
\begin{frame}[label={sec:orgb4e6f0d},fragile]{Applicative laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org5df0786},fragile,t]{Parsing}
 \vspace*{20px}
...
\begin{frame}[label={sec:orgd7d38ff},fragile,t]{Simple parser}
 \begin{minted}[]{scala}
case class Parser[A](parse: String => ParserResult[A])
\end{minted}
...
\begin{frame}[label={sec:orga0a392c},fragile]{Abstracting \texttt{char}}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org9be8ca3},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgabaa5dd},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgdac1b24},fragile,t]{(invalid) UUID parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org7309915},fragile,t]{Space invaders}
 \begin{minted}[]{scala}
def uuid: Parser[String] = /* ... */
...
\begin{frame}[label={sec:orgdf3595a}]{So\ldots{}}
\begin{center}
\includegraphics[height=5cm]{images/applicative-confusion.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgec7e64a},fragile,t]{Simple case class example}
 \begin{onlyenv}<1->
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org9e4c1b1},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org29204fa}]{Outcome}
\begin{itemize}
...
\section{Validation}
\label{sec:orgbf44022}

\begin{frame}[label={sec:org411bd93},fragile]{Validation}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org695a6fd},fragile]{Person}
 \begin{minted}[]{scala}
case class Person(name: String, age: Int)
\end{minted}
...
\begin{frame}[label={sec:orga3b88cd},fragile]{Person}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org13f6265},fragile]{Quest for 'all errors'}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgd2236ad},fragile]{What's wrong with Either?}
...
\begin{frame}[label={sec:orgc8d5f73},fragile]{Doing as much as we can}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org446f68d},fragile]{Coding time}
 \begin{itemize}
