...
\section*{Intro}
\label{sec:org0a4e81d}
\begin{frame}[label={sec:org7d15d1f}]{About us}
\vspace*{20px}
...
\begin{frame}[label={sec:org6fd76e2}]{About the Forkshop}
\begin{itemize}
...
\begin{frame}[label={sec:orgdf58a8a},fragile]{Whys}
 \begin{itemize}
...
\section*{Today}
\label{sec:orgca737dd}
\begin{frame}[label={sec:org0622523}]{Agenda}
\begin{itemize}
...
\begin{frame}[label={sec:org114d40c},fragile]{Before we start}
 \begin{minted}[]{bash}
...
\section{Type theory}
\label{sec:orgdb3bb27}
\begin{frame}[label={sec:orgfd9fec9}]{Values and types}
...
\begin{frame}[label={sec:org98d4bdb},fragile]{Nullary value constructors}
...
\begin{frame}[label={sec:org1bbfa7d},fragile]{Unary value constructors: function}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgd33e495},fragile]{Unary value constructors: class}
...
\begin{frame}[label={sec:orgabce56e},fragile]{Higher arity}
...
\begin{frame}[label={sec:org0e3b8d6},fragile]{Nullary type constructors}
...
\begin{frame}[label={sec:org8f28984},fragile]{Unary type constructors}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org5f6fd4a},fragile]{Higher arity}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org294d8b9},fragile]{Kinds}
...
\begin{frame}[label={sec:org50e1766},fragile]{Examples}
 \begin{itemize}
...
\begin{frame}[label={sec:orge297f5a},fragile]{Higher-order functions}
...
\begin{frame}[label={sec:org16e9c39},fragile]{Higher-order types (1)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org54ffcf3},fragile]{Higher-order types (2)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgcd19c1f}]{Higher-order types (3)}
...
\begin{frame}[label={sec:org1727fb8}]{The most important question}
\begin{center}
...
\section{Functor}
\label{sec:org2a1da5d}
\begin{frame}[label={sec:org10dd03d}]{Function Application}
...
\begin{frame}[label={sec:org6456e84},fragile]{Function Application}
...
\begin{frame}[label={sec:org5238cd5},fragile]{Function Application}
...
\begin{frame}[label={sec:orga14bcf7},fragile]{Context: optional value}
...
\begin{frame}[label={sec:orgda8e741},fragile]{Context: optional value}
 \begin{itemize}
...
\begin{frame}[label={sec:org7fae9ac},fragile]{Context: optional value}
 \begin{minted}[]{scala}
//  apply        : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:orga95b271},fragile]{Many contexts}
 \begin{itemize}
...
\begin{frame}[label={sec:org764e186},fragile]{Many applies}
 \begin{minted}[]{scala}
def apply           : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:orgbc188f6}]{Repetition is}
\begin{center}
...
\begin{frame}[label={sec:orgc4174ca},fragile]{Functoriana}
 \begin{minted}[]{scala}
trait Functor[F[_]] {
...
\begin{frame}[label={sec:orgfaec3ca},fragile]{Code responsibly, know the laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org35073dd}]{Sum type: Option}
\begin{center}
...
\begin{frame}[label={sec:orgeeac8d4},fragile]{Breaking the Option}
 \begin{minted}[]{scala}
  fmap(identity)(value)
= identity(value)
= value
...
\begin{frame}[label={sec:orgbe7cb2c},fragile]{Product type: List}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orga341164},fragile,t]{Breaking the List}
 \begin{onlyenv}<1-2>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org3ce075d}]{What about the second rule?}
...
\begin{frame}[label={sec:orgd0dfa7c}]{There can be only one}
There is only one lawful implementation of Functor for a given type.
\end{frame}

\begin{frame}[label={sec:org9612b88},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:orga12e5f8},fragile]{Outcome}
 \begin{itemize}
...
\label{sec:org7072d30}

\begin{frame}[label={sec:org5bf0e04},fragile]{Next step}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:org9b328a2},fragile]{Next step}
 \begin{minted}[]{scala}
def apply :  (A => B) =>   A  =>   B
...
\begin{frame}[label={sec:org20af2cb},fragile]{Solution}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:org7291ebb},fragile]{Following the same idea}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org271569a},fragile]{What's about pure?}
 \begin{columns}
...
\begin{frame}[label={sec:org8f66626},fragile]{Another perspective}
...
\begin{frame}[label={sec:orgfb85063},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org4b72d83},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orge7f1f52},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org49fdb2f},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgecc1ae5},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org4ff832a},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org8d94510},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{minted}[]{scala}
class MonoidalToApplicative[F[_]: Monoidal]() extends Applicative[F] {
  override def pure[A](a: A): F[A] = Monoidal[F].unit.fmap(_ => a)
...
\begin{frame}[label={sec:orge8c5239},fragile]{Some symmetry}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org2cc6fbd},fragile]{Monoid part of \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Monoid[A] {
...
\begin{frame}[label={sec:orgb042522},fragile]{Applicative laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org3d8dd38},fragile]{Monoidal laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org53cc4fa},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org78275ff},fragile]{Conditionals}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org58366d8},fragile]{Outcome}
 \begin{itemize}
...
\section{Parsing}
\label{sec:org7bcf723}

\begin{frame}[label={sec:orgcc54440},fragile,t]{Parsing}
 \vspace*{20px}
...
\begin{frame}[label={sec:org388f433},fragile,t]{Simple parser}
 \begin{minted}[]{scala}
case class Parser[A](parse: String => ParserResult[A])
\end{minted}
...
\begin{frame}[label={sec:org7d8d7a2},fragile]{Abstracting \texttt{char}}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org78cee23},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgd7ea172},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org18aa40d},fragile,t]{(invalid) UUID parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org4e8ad7e},fragile,t]{Space invaders}
 \begin{minted}[]{scala}
def uuid: Parser[String] = /* ... */
...
\begin{frame}[label={sec:orgddcdd1f}]{So\ldots{}}
\begin{center}
\includegraphics[height=5cm]{images/applicative-confusion.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgf250782},fragile,t]{Simple case class example}
 \begin{onlyenv}<1->
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org6d2cd8d},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org176927d}]{Outcome}
\begin{itemize}
...
\section{Validation}
\label{sec:orgeac7a0f}

\begin{frame}[label={sec:orgd4b12c3},fragile]{Validation}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org42c3332},fragile]{Person}
 \begin{minted}[]{scala}
case class Person(name: String, age: Int)
\end{minted}
...
\begin{frame}[label={sec:orgb40bd97},fragile]{Person}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org75afaf5},fragile]{Quest for 'all errors'}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgcb7d877},fragile]{What's wrong with Either?}
...
\begin{frame}[label={sec:orgc912ab9},fragile]{Doing as much as we can}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgca782cb},fragile]{Coding time}
 \begin{itemize}
...
\section*{Final words}
\label{sec:orgab1c5f1}
\begin{frame}[label={sec:orgb179477},fragile]{Recap}
 \begin{onlyenv}
\begin{itemize}
...
\section*{References}
\label{sec:org3cd17be}
\begin{frame}[label={sec:org0482d05}]{References}
\begin{itemize}
...
\section{Questions?}
\label{sec:org33410ed}

\section{Thank you very much!}
\label{sec:org91ec12e}
\end{document}
