...
\section*{Intro}
\label{sec:orgb428a92}
\begin{frame}[label={sec:orga267fd2}]{About us}
\vspace*{20px}
...
\begin{frame}[label={sec:org44a5d72}]{About the Forkshop}
\begin{itemize}
...
\begin{frame}[label={sec:orgee3a4cf},fragile]{Whys}
 \begin{itemize}
...
\section*{Today}
\label{sec:org42a8b40}
\begin{frame}[label={sec:orgd6782df}]{Agenda}
\begin{itemize}
...
\begin{frame}[label={sec:org9b90087},fragile]{Before we start}
 \begin{minted}[]{bash}
...
\section{Type theory}
\label{sec:orge887055}
\begin{frame}[label={sec:orgff9f755}]{Values and types}
...
\begin{frame}[label={sec:orgc10deab},fragile]{Nullary value constructors}
...
\begin{frame}[label={sec:org83803ea},fragile]{Unary value constructors: function}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgc740163},fragile]{Unary value constructors: class}
...
\begin{frame}[label={sec:org56fc86e},fragile]{Higher arity}
...
\begin{frame}[label={sec:org491732c},fragile]{Nullary type constructors}
...
\begin{frame}[label={sec:org4458b3b},fragile]{Unary type constructors}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org3247846},fragile]{Higher arity}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org8b0558d},fragile]{Kinds}
...
\begin{frame}[label={sec:org90706f1},fragile]{Examples}
 \begin{itemize}
...
\begin{frame}[label={sec:org6bcf929},fragile]{Higher-order functions}
...
\begin{frame}[label={sec:org4496208},fragile]{Higher-order types (1)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org7472fd8},fragile]{Higher-order types (2)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org6fd8194}]{Higher-order types (3)}
...
\begin{frame}[label={sec:org7f95627}]{The most important question}
\begin{center}
...
\section{Functor}
\label{sec:org6b9ab0a}
\begin{frame}[label={sec:org74d711a}]{Function Application}
...
\begin{frame}[label={sec:orgfe94542},fragile]{Function Application}
...
\begin{frame}[label={sec:orgad5bff5},fragile]{Function Application}
...
\begin{frame}[label={sec:orgda76958},fragile]{Context: optional value}
...
\begin{frame}[label={sec:orga183dab},fragile]{Context: optional value}
 \begin{itemize}
...
\begin{frame}[label={sec:org26d9a03},fragile]{Context: optional value}
 \begin{minted}[]{scala}
//  apply        : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:org822c4a0},fragile]{Many contexts}
 \begin{itemize}
...
\begin{frame}[label={sec:org4c8f2cb},fragile]{Many applies}
 \begin{minted}[]{scala}
def apply           : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:orgac32024}]{Repetition is}
\begin{center}
...
\begin{frame}[label={sec:org709799d},fragile]{Functoriana}
 \begin{minted}[]{scala}
trait Functor[F[_]] {
...
\begin{frame}[label={sec:org5fdf228},fragile]{Code responsibly, know the laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org74b4d64}]{Sum type: Option}
\begin{center}
...
\begin{frame}[label={sec:orgea96ee1},fragile]{Breaking the Option}
 \begin{minted}[]{scala}
  fmap(identity)(value)
= identity(value)
= value
...
\begin{frame}[label={sec:org9ae1ede},fragile]{Product type: List}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgfdad1bd},fragile,t]{Breaking the List}
 \begin{onlyenv}<1-2>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgea04324}]{What about the second rule?}
...
\begin{frame}[label={sec:org87a9dc5}]{There can be only one}
There is only one lawful implementation of Functor for a given type.
\end{frame}

\begin{frame}[label={sec:org24db7d9},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:orgd0b788b},fragile]{Outcome}
 \begin{itemize}
...
\label{sec:org42a71c5}

\begin{frame}[label={sec:org7971623},fragile]{Next step}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:orgb1e28b7},fragile]{Next step}
 \begin{minted}[]{scala}
def apply :  (A => B) =>   A  =>   B
...
\begin{frame}[label={sec:org7fae356},fragile]{Solution}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:org32fafe8},fragile]{Following the same idea}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgdb8465a},fragile]{What's about pure?}
 \begin{columns}
...
\begin{frame}[label={sec:org6e91cf6},fragile]{Another perspective}
...
\begin{frame}[label={sec:orgfb6be3f},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org8788c62},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgf7d71f0},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org5622c5a},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org754b97a},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org73e6150},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgc9657c2},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{minted}[]{scala}
class MonoidalToApplicative[F[_]: Monoidal]() extends Applicative[F] {
  override def pure[A](a: A): F[A] = Monoidal[F].unit.fmap(_ => a)
...
\begin{frame}[label={sec:org88639d9},fragile]{Monoid part of \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Monoid[A] {
...
\begin{frame}[label={sec:orgb2597af},fragile]{Applicative laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org9857723},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org35a70a2},fragile]{Outcome}
 \begin{itemize}
...
\section{Parsing}
\label{sec:org3636c3c}

\begin{frame}[label={sec:orgb6ab241},fragile,t]{Parsing}
 \vspace*{20px}
...
\begin{frame}[label={sec:orge369635},fragile,t]{Simple parser}
 \begin{minted}[]{scala}
case class Parser[A](parse: String => ParserResult[A])
\end{minted}
...
\begin{frame}[label={sec:orgcd45398},fragile]{Abstracting \texttt{char}}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org5d1640f},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org4d64846},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgde0087d},fragile,t]{(invalid) UUID parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgb1d9907},fragile,t]{Space invaders}
 \begin{minted}[]{scala}
def uuid: Parser[String] = /* ... */
...
\begin{frame}[label={sec:org3fe6ffd}]{So\ldots{}}
\begin{center}
\includegraphics[height=5cm]{images/applicative-confusion.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:org3c4626b},fragile,t]{Simple case class example}
 \begin{onlyenv}<1->
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgbe6ffd5},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org88f754f}]{Outcome}
\begin{itemize}
...
\section{Validation}
\label{sec:org13dbcf5}

\begin{frame}[label={sec:orgb2dd700},fragile]{Validation}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org65542b4},fragile]{Person}
 \begin{minted}[]{scala}
case class Person(name: String, age: Int)
\end{minted}
...
\begin{frame}[label={sec:org4fac352},fragile]{Person}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgce19191},fragile]{Quest for 'all errors'}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgb23870e},fragile]{What's wrong with Either?}
...
\begin{frame}[label={sec:orgbed248a},fragile]{Doing as much as we can}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org665bbe2},fragile]{Coding time}
 \begin{itemize}
...
\section*{Final words}
\label{sec:orgf671a63}
\begin{frame}[label={sec:orgabd602e},fragile]{Recap}
 \begin{onlyenv}
\begin{itemize}
...
\section{Questions?}
\label{sec:org33a99a0}

\section{Thank you very much!}
\label{sec:org3d049bb}
\end{document}
