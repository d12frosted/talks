...
\section*{Intro}
\label{sec:org2ce261b}
\begin{frame}[label={sec:orga4a1a94}]{About us}
\vspace*{20px}
...
\begin{frame}[label={sec:orgaaa6033}]{About the Forkshop}
\begin{itemize}
...
\begin{frame}[label={sec:org639241e},fragile]{Whys}
 \begin{itemize}
...
\section*{Today}
\label{sec:orgdb13d22}
\begin{frame}[label={sec:org43d6453}]{Agenda}
\begin{itemize}
...
\begin{frame}[label={sec:org8e3b254},fragile]{Before we start}
 \begin{minted}[]{bash}
...
\section{Type theory}
\label{sec:orgc0af4c8}
\begin{frame}[label={sec:org0c33c99}]{Values and types}
...
\begin{frame}[label={sec:org59f8de8},fragile]{Nullary value constructors}
...
\begin{frame}[label={sec:org1af8e18},fragile]{Unary value constructors: function}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgf04fb3f},fragile]{Unary value constructors: class}
...
\begin{frame}[label={sec:orgbe06d35},fragile]{Higher arity}
...
\begin{frame}[label={sec:orgad501d2},fragile]{Nullary type constructors}
...
\begin{frame}[label={sec:orgc67f5b4},fragile]{Unary type constructors}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org30d525e},fragile]{Higher arity}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org73e0855},fragile]{Kinds}
...
\begin{frame}[label={sec:org5538396},fragile]{Examples}
 \begin{itemize}
...
\begin{frame}[label={sec:org4b6ac49},fragile]{Higher-order functions}
...
\begin{frame}[label={sec:org20d5e1c},fragile]{Higher-order types (1)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgf231342},fragile]{Higher-order types (2)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org97ac4ee}]{Higher-order types (3)}
...
\begin{frame}[label={sec:orgfd67972}]{The most important question}
\begin{center}
...
\section{Functor}
\label{sec:orgbf19700}
\begin{frame}[label={sec:orgd84b0d3}]{Function Application}
...
\begin{frame}[label={sec:org5fc88d3},fragile]{Function Application}
...
\begin{frame}[label={sec:org9432458},fragile]{Function Application}
...
\begin{frame}[label={sec:orge40c61f},fragile]{Context: optional value}
...
\begin{frame}[label={sec:orgf0429c2},fragile]{Context: optional value}
 \begin{itemize}
...
\begin{frame}[label={sec:orgb271ad8},fragile]{Context: optional value}
 \begin{minted}[]{scala}
//  apply        : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:orgbd92f29},fragile]{Many contexts}
 \begin{itemize}
...
\begin{frame}[label={sec:org5d7975c},fragile]{Many applies}
 \begin{minted}[]{scala}
def apply           : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:org777a4f3}]{Repetition is}
\begin{center}
...
\begin{frame}[label={sec:orgf0574d3},fragile]{Functoriana}
 \begin{minted}[]{scala}
trait Functor[F[_]] {
...
\begin{frame}[label={sec:org9bcb3ea},fragile]{Code responsibly, know the laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:orgac0df7b}]{Sum type: Option}
\begin{center}
...
\begin{frame}[label={sec:orgf123ccb},fragile]{Breaking the Option}
 \begin{minted}[]{scala}
  fmap(identity)(value)
= identity(value)
= value
...
\begin{frame}[label={sec:org25a8e3b},fragile]{Product type: List}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org3ed572b},fragile,t]{Breaking the List}
 \begin{onlyenv}<1-2>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgdcb86ef}]{What about the second rule?}
...
\begin{frame}[label={sec:org54ee8a4}]{There can be only one}
There is only one lawful implementation of Functor for a given type.
\end{frame}

\begin{frame}[label={sec:orga00a0cf},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:orgeb66d66},fragile]{Outcome}
 \begin{itemize}
...
\label{sec:org690b3b5}

\begin{frame}[label={sec:orgb553c08},fragile]{Next step}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:org80edecb},fragile]{Next step}
 \begin{minted}[]{scala}
def apply :  (A => B) =>   A  =>   B
...
\begin{frame}[label={sec:orgeb57a43},fragile]{Solution}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:orgcaf169b},fragile]{Following the same idea}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org432785f},fragile]{What's about pure?}
 \begin{columns}
...
\begin{frame}[label={sec:org8ee1abf},fragile]{Another perspective}
...
\begin{frame}[label={sec:org0b69d27},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org61a71e0},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgf9ca0a9},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgda81b02},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgaa56872},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org4f2661a},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgbeb941d},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{minted}[]{scala}
class MonoidalToApplicative[F[_]: Monoidal]() extends Applicative[F] {
  override def pure[A](a: A): F[A] = Monoidal[F].unit.fmap(_ => a)
...
\begin{frame}[label={sec:org94b8f9e},fragile]{Monoid part of \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Monoid[A] {
...
\begin{frame}[label={sec:orgb91eb9b},fragile]{Applicative laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org56d1e00},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org446d0db},fragile]{Outcome}
 \begin{itemize}
...
\section{Parsing}
\label{sec:org2e299c8}

\begin{frame}[label={sec:org0bbfadd},fragile,t]{Parsing}
 \vspace*{20px}
...
\begin{frame}[label={sec:orgea628f9},fragile,t]{Simple parser}
 \begin{minted}[]{scala}
case class Parser[A](parse: String => ParserResult[A])
\end{minted}
...
\begin{frame}[label={sec:org2428dde},fragile]{Abstracting \texttt{char}}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org069d5f0},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org3aebdf0},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org608ccdc},fragile,t]{(invalid) UUID parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org22e4edd},fragile,t]{Space invaders}
 \begin{minted}[]{scala}
def uuid: Parser[String] = /* ... */
...
\begin{frame}[label={sec:org6787f79}]{So\ldots{}}
\begin{center}
\includegraphics[height=5cm]{images/applicative-confusion.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgb815ca2},fragile,t]{Simple case class example}
 \begin{onlyenv}<1->
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org86b3f47},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:orgdcdf6d1}]{Outcome}
\begin{itemize}
...
\section{Validation}
\label{sec:org05eeedf}

\begin{frame}[label={sec:org07de119},fragile]{Validation}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org2a0ddf4},fragile]{Person}
 \begin{minted}[]{scala}
case class Person(name: String, age: Int)
\end{minted}
...
\begin{frame}[label={sec:org552c811},fragile]{Person}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgd5e184d},fragile]{Quest for 'all errors'}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgd286fc5},fragile]{What's wrong with Either?}
...
\begin{frame}[label={sec:org016647e},fragile]{Doing as much as we can}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org8fc53b5},fragile]{Coding time}
 \begin{itemize}
...
\section*{Final words}
\label{sec:orgf256494}
\begin{frame}[label={sec:org3d23456},fragile]{Recap}
 \begin{onlyenv}
\begin{itemize}
...
\section{Questions?}
\label{sec:org88a636d}

\section{Thank you very much!}
\label{sec:org04631fa}
\end{document}
