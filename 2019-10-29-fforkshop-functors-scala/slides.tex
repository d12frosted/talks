...
\section*{Intro}
\label{sec:org55912e5}
\begin{frame}[label={sec:orgd914528}]{About us}
\vspace*{20px}
...
\begin{frame}[label={sec:orgebff76c},fragile]{Unary type constructors}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org8a6bbb8},fragile]{Higher arity}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org3db8245},fragile]{Kinds}
...
\begin{frame}[label={sec:orgdbc8258},fragile]{Examples}
 \begin{itemize}
...
\begin{frame}[label={sec:org0a5c352},fragile]{Higher-order functions}
...
\begin{frame}[label={sec:org0a09fc2},fragile]{Higher-order types (1)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org35aeeab},fragile]{Higher-order types (2)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org6251132}]{Higher-order types (3)}
...
\begin{frame}[label={sec:orgae30e28}]{The most important question}
\begin{center}
...
\section{Functor}
\label{sec:orgc9a3324}
\begin{frame}[label={sec:org580aab2}]{Function Application}
...
\begin{frame}[label={sec:org3b57142},fragile]{Function Application}
...
\begin{frame}[label={sec:org83bcdf5},fragile]{Function Application}
...
\begin{frame}[label={sec:org8657fb9},fragile]{Many contexts}
 \begin{itemize}
...
\begin{frame}[label={sec:orgcddc7f4},fragile]{Many applies}
 \begin{minted}[]{scala}
def apply           : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:org77bed7b}]{Repetition is}
\begin{center}
...
\begin{frame}[label={sec:org3672c27},fragile]{Functoriana}
 \begin{minted}[]{scala}
trait Functor[F[_]] {
...
\begin{frame}[label={sec:orgb56f98a}]{What about the second rule?}
...
\begin{frame}[label={sec:org57a4bc1}]{There can be only one}
There is only one lawful implementation of Functor for a given type.
\end{frame}

\begin{frame}[label={sec:orgd1960c5},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org8e32550},fragile]{Outcome}
 \begin{itemize}
...
\label{sec:org4edce7e}

\begin{frame}[label={sec:org378cb40},fragile]{Next step}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:orgf406f1e},fragile]{Next step}
 \begin{minted}[]{scala}
def apply :  (A => B) =>   A  =>   B
...
\begin{frame}[label={sec:orgf3487d0},fragile]{Solution}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:org02d0d8e},fragile]{Another perspective}
...
\begin{frame}[label={sec:org320c7a4},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org82a1cd7},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgf947d66},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org61c5158},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgd99b0c0},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org991250c},fragile]{Monoid part of \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Monoid[A] {
...
\begin{frame}[label={sec:org6fd2452},fragile]{Applicative laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:orgdcf3dcf},fragile,t]{Parsing}
 \vspace*{20px}
...
\begin{frame}[label={sec:org9db1666},fragile,t]{Simple parser}
 \begin{minted}[]{scala}
case class Parser[A](parse: String => ParserResult[A])
\end{minted}
...
\begin{frame}[label={sec:org83a1590},fragile]{Abstracting \texttt{char}}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgaec0550},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org703a70d},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org3964c09},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:orge6e9679}]{Outcome}
\begin{itemize}
...
\section{Validation}
\label{sec:orgad11b7d}

\begin{frame}[label={sec:orga40d8e1},fragile]{Validation}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgaea4a5d},fragile]{Person}
 \begin{minted}[]{scala}
case class Person(name: String, age: Int)
\end{minted}
...
\begin{frame}[label={sec:orgbb1ea1b},fragile]{Person}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org85685a2},fragile]{Quest for 'all errors'}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org3d10ee5},fragile]{What's wrong with Either?}
...
\begin{frame}[label={sec:orge7c0de1},fragile]{Doing as much as we can}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgb017656},fragile]{Coding time}
 \begin{itemize}
