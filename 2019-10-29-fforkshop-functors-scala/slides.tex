...
\section*{Intro}
\label{sec:orgf289ff2}
\begin{frame}[label={sec:orgf02a658}]{About us}
\vspace*{20px}
...
\begin{frame}[label={sec:org45155e6}]{About the Forkshop}
\begin{itemize}
...
\begin{frame}[label={sec:org4849deb},fragile]{Whys}
 \begin{itemize}
...
\section*{Today}
\label{sec:orgd787dd3}
\begin{frame}[label={sec:org90d3cf8}]{Agenda}
\begin{itemize}
...
\begin{frame}[label={sec:org3e7432d},fragile]{Before we start}
 \begin{minted}[]{bash}
...
\section{Type theory}
\label{sec:org2d8d27a}
\begin{frame}[label={sec:orgde29f83}]{Values and types}
...
\begin{frame}[label={sec:org5154527},fragile]{Nullary value constructors}
...
\begin{frame}[label={sec:org26e76d1},fragile]{Unary value constructors: function}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org8a836e8},fragile]{Unary value constructors: class}
...
\begin{frame}[label={sec:orga6c3434},fragile]{Higher arity}
...
\begin{frame}[label={sec:org1a95e17},fragile]{Nullary type constructors}
...
\begin{frame}[label={sec:org22cdf41},fragile]{Unary type constructors}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgef87a40},fragile]{Higher arity}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgfccbe75},fragile]{Kinds}
...
\begin{frame}[label={sec:org605174a},fragile]{Examples}
 \begin{itemize}
...
\begin{frame}[label={sec:org9d3b9b6},fragile]{Higher-order functions}
...
\begin{frame}[label={sec:org4b10808},fragile]{Higher-order types (1)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org3bad58d},fragile]{Higher-order types (2)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org6cca593}]{Higher-order types (3)}
...
\begin{frame}[label={sec:org2659cbe}]{The most important question}
\begin{center}
...
\section{Functor}
\label{sec:org6217ad4}
\begin{frame}[label={sec:org2066d05}]{Function Application}
...
\begin{frame}[label={sec:org5680fba},fragile]{Function Application}
...
\begin{frame}[label={sec:org4caee46},fragile]{Function Application}
...
\begin{frame}[label={sec:org64e5823},fragile]{Context: optional value}
...
\begin{frame}[label={sec:org52e7436},fragile]{Context: optional value}
 \begin{itemize}
...
\begin{frame}[label={sec:org309e175},fragile]{Context: optional value}
 \begin{minted}[]{scala}
//  apply        : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:org7b383c7},fragile]{Many contexts}
 \begin{itemize}
...
\begin{frame}[label={sec:org30f42fc},fragile]{Many applies}
 \begin{minted}[]{scala}
def apply           : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:org197d067}]{Repetition is}
\begin{center}
...
\begin{frame}[label={sec:org3bba8c2},fragile]{Functoriana}
 \begin{minted}[]{scala}
trait Functor[F[_]] {
...
\begin{frame}[label={sec:orgf9cfb84},fragile]{Code responsibly, know the laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org54b0cd0}]{Sum type: Option}
\begin{center}
...
\begin{frame}[label={sec:org372e479},fragile]{Breaking the Option}
 \begin{minted}[]{scala}
  fmap(identity)(value)
= identity(value)
= value
...
\begin{frame}[label={sec:orgb23e3a6},fragile]{Product type: List}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgcd4fa40},fragile,t]{Breaking the List}
 \begin{onlyenv}<1-2>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org159eb61}]{What about the second rule?}
...
\begin{frame}[label={sec:orgb8ec275},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org6965ef4},fragile]{Outcome}
 \begin{itemize}
...
\label{sec:orgac02c29}

\begin{frame}[label={sec:orgeda66e2},fragile]{Next step}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:orgb9fd049},fragile]{Next step}
 \begin{minted}[]{scala}
def apply :  (A => B) =>   A  =>   B
...
\begin{frame}[label={sec:orge114db0},fragile]{Solution}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:org60c5788},fragile]{Following the same idea}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgb35459a},fragile]{What's about pure?}
 \begin{enumerate}
...
\begin{frame}[label={sec:org20aa452},fragile]{Another perspective}
...
\begin{frame}[label={sec:org99d8851},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org7f31c33},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org7bc46b1},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org3cb57a5},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org9ab4870},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgebd51f6},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org5604221},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{minted}[]{scala}
class MonoidalToApplicative[F[_]: Monoidal]() extends Applicative[F] {
  override def pure[A](a: A): F[A] = Monoidal[F].unit.fmap(_ => a)
...
\begin{frame}[label={sec:org9671467},fragile]{Monoid part of \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Monoid[A] {
...
\begin{frame}[label={sec:orgc55d8b7},fragile]{Applicative laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:orgc96dd68},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org2491506},fragile]{Outcome}
 \begin{itemize}
...
\section{Parsing}
\label{sec:orgaac147e}

\begin{frame}[label={sec:org91da716},fragile,t]{Parsing}
 \vspace*{20px}
...
\begin{frame}[label={sec:org5a45a58},fragile,t]{Simple parser}
 \vspace*{20px}
...
\begin{frame}[label={sec:org5b44ad0},fragile]{Abstracting \texttt{char}}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org37084a4},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgcc4d568},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgf90cea5},fragile,t]{(invalid) UUID parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgfeb4051},fragile,t]{Space invaders}
 \begin{minted}[]{scala}
def uuid: Parser[String] = /* ... */
...
\begin{frame}[label={sec:orga6c1ba0}]{So\ldots{}}
\begin{center}
\includegraphics[height=5cm]{images/applicative-confusion.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:org59abd2c},fragile,t]{Simple case class example}
 \begin{onlyenv}<1->
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgdf039f0},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:orga40b33e}]{Outcome}
\begin{itemize}
...
\section{Validation}
\label{sec:org21bca9f}

\begin{frame}[label={sec:orgb930bf6},fragile]{Validation}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org991a953},fragile]{Person}
 \begin{minted}[]{scala}
case class Person(name: String, age: Int)
\end{minted}
...
\begin{frame}[label={sec:org83c2b9d},fragile]{Person}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org8366f94},fragile]{Quest for 'all errors'}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org216413d},fragile]{What's wrong with Either?}
...
\begin{frame}[label={sec:org5a3956c},fragile]{Doing as much as we can}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org7e5ff7e},fragile]{Coding time}
 \begin{itemize}
...
\section*{Final words}
\label{sec:orgab0b0d4}
\begin{frame}[label={sec:org731a81d},fragile]{Recap}
 \begin{onlyenv}
\begin{itemize}
...
\section{Questions?}
\label{sec:orgf6185a8}

\section{Thank you very much!}
\label{sec:org6d860c2}
\end{document}
