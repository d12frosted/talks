...
\section*{Intro}
\label{sec:orgd7acfb0}
\begin{frame}[label={sec:org4da37d5}]{About us}
\vspace*{20px}
...
\begin{frame}[label={sec:org41e6755}]{About the Forkshop}
\begin{itemize}
...
\begin{frame}[label={sec:orgb57f2a2},fragile]{Whys}
 \begin{itemize}
...
\section*{Today}
\label{sec:org237e8d5}
\begin{frame}[label={sec:org99d7ef2}]{Agenda}
\begin{itemize}
...
\begin{frame}[label={sec:orgf9993b1},fragile]{Before we start}
 \begin{minted}[]{bash}
...
\section{Type theory}
\label{sec:org29ce2a4}
\begin{frame}[label={sec:orge8bec22}]{Values and types}
...
\begin{frame}[label={sec:orge9dee0e},fragile]{Nullary value constructors}
...
\begin{frame}[label={sec:orgfafb8f5},fragile]{Unary value constructors: function}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org5e5c94a},fragile]{Unary value constructors: class}
...
\begin{frame}[label={sec:orgcfc3b9c},fragile]{Higher arity}
...
\begin{frame}[label={sec:org3c938bd},fragile]{Nullary type constructors}
...
\begin{frame}[label={sec:orgc27e953},fragile]{Unary type constructors}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org5fef640},fragile]{Higher arity}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgfdbb8e4},fragile]{Kinds}
...
\begin{frame}[label={sec:org359b1f6},fragile]{Examples}
 \begin{itemize}
...
\begin{frame}[label={sec:org15e1d13},fragile]{Higher-order functions}
...
\begin{frame}[label={sec:org7f03db8},fragile]{Higher-order types (1)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgbda492e},fragile]{Higher-order types (2)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org8291157}]{Higher-order types (3)}
...
\begin{frame}[label={sec:org5f15d1b}]{The most important question}
\begin{center}
...
\section{Functor}
\label{sec:orgc4770a5}
\begin{frame}[label={sec:org2ce137f}]{Function Application}
...
\begin{frame}[label={sec:org1fd9d3a},fragile]{Function Application}
...
\begin{frame}[label={sec:org18b4067},fragile]{Function Application}
...
\begin{frame}[label={sec:org0a8ef11},fragile]{Context: optional value}
...
\begin{frame}[label={sec:org43c3c0e},fragile]{Context: optional value}
 \begin{itemize}
...
\begin{frame}[label={sec:org3e66d65},fragile]{Context: optional value}
 \begin{minted}[]{scala}
//  apply        : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:org8af3d4a},fragile]{Many contexts}
 \begin{itemize}
...
\begin{frame}[label={sec:orgccca5ba},fragile]{Many applies}
 \begin{minted}[]{scala}
def apply           : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:orgccba0b1}]{Repetition is}
\begin{center}
...
\begin{frame}[label={sec:org8c647d4},fragile]{Functoriana}
 \begin{minted}[]{scala}
trait Functor[F[_]] {
...
\begin{frame}[label={sec:org497ec47},fragile]{Code responsibly, know the laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org876215e}]{Sum type: Option}
\begin{center}
...
\begin{frame}[label={sec:org74fb254},fragile]{Breaking the Option}
 \begin{minted}[]{scala}
  fmap(identity)(value)
= identity(value)
= value
...
\begin{frame}[label={sec:orgb427b0f},fragile]{Product type: List}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orge116b71},fragile,t]{Breaking the List}
 \begin{onlyenv}<1-2>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org3768c40}]{What about the second rule?}
...
\begin{frame}[label={sec:org62dc8c1}]{There can be only one}
There is only one lawful implementation of Functor for a given type.
\end{frame}

\begin{frame}[label={sec:org3054310},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org56ba532},fragile]{Outcome}
 \begin{itemize}
...
\label{sec:org065691b}

\begin{frame}[label={sec:org1a91349},fragile]{Next step}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:orgb2125c2},fragile]{Next step}
 \begin{minted}[]{scala}
def apply :  (A => B) =>   A  =>   B
...
\begin{frame}[label={sec:org3747899},fragile]{Solution}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:org4e9dc91},fragile]{Following the same idea}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org4d12a40},fragile]{What's about pure?}
 \begin{columns}
...
\begin{frame}[label={sec:orgfc16f5d},fragile]{Another perspective}
...
\begin{frame}[label={sec:org0e429f1},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org0230a3e},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org2f6108b},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgf7e4e57},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgc1ec6db},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org0d3d457},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org915334d},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{minted}[]{scala}
class MonoidalToApplicative[F[_]: Monoidal]() extends Applicative[F] {
  override def pure[A](a: A): F[A] = Monoidal[F].unit.fmap(_ => a)
...
\begin{frame}[label={sec:orgb44719d},fragile]{Some symmetry}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgb4df30b},fragile]{Monoid part of \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Monoid[A] {
...
\begin{frame}[label={sec:orgdf9f93d},fragile]{Applicative laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org3e9fc47},fragile]{Monoidal laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org08e9f6c},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org296f27b},fragile]{Conditionals}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orga0937c0},fragile]{Outcome}
 \begin{itemize}
...
\section{Parsing}
\label{sec:org06070f9}

\begin{frame}[label={sec:orgbaea75c},fragile,t]{Parsing}
 \vspace*{20px}
...
\begin{frame}[label={sec:org7e51fed},fragile,t]{Simple parser}
 \begin{minted}[]{scala}
case class Parser[A](parse: String => ParserResult[A])
\end{minted}
...
\begin{frame}[label={sec:org717c809},fragile]{Abstracting \texttt{char}}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orge66c5f1},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgd70002e},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org4f1c026},fragile,t]{(invalid) UUID parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org7823021},fragile,t]{Space invaders}
 \begin{minted}[]{scala}
def uuid: Parser[String] = /* ... */
...
\begin{frame}[label={sec:org3d7694b}]{So\ldots{}}
\begin{center}
\includegraphics[height=5cm]{images/applicative-confusion.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:org23045a1},fragile,t]{Simple case class example}
 \begin{onlyenv}<1->
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org25726b4},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:orga61c2fd}]{Outcome}
\begin{itemize}
...
\section{Validation}
\label{sec:org322cf88}

\begin{frame}[label={sec:orgf54b2f5},fragile]{Validation}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgaac7145},fragile]{Person}
 \begin{minted}[]{scala}
case class Person(name: String, age: Int)
\end{minted}
...
\begin{frame}[label={sec:org18c5e34},fragile]{Person}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org504bd2f},fragile]{Quest for 'all errors'}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgad28ff9},fragile]{What's wrong with Either?}
...
\begin{frame}[label={sec:org2a6a5b6},fragile]{Doing as much as we can}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org810c2df},fragile]{Coding time}
 \begin{itemize}
...
\section*{Final words}
\label{sec:org7e58ddb}
\begin{frame}[label={sec:orgb2beac0},fragile]{Recap}
 \begin{onlyenv}
\begin{itemize}
...
\section*{References}
\label{sec:org920d81f}
\begin{frame}[label={sec:orgf1b9189}]{References}
\begin{itemize}
...
\section{Questions?}
\label{sec:org33abfcf}

\section{Thank you very much!}
\label{sec:org6f0b3f7}
\end{document}
