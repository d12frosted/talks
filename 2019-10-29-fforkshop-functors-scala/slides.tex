...
\section*{Intro}
\label{sec:org08a838a}
\begin{frame}[label={sec:orgcbe74d8}]{About us}
\vspace*{20px}
...
\begin{frame}[label={sec:org10a481c}]{About the Forkshop}
\begin{itemize}
...
\begin{frame}[label={sec:orgeeb6a00},fragile]{Whys}
 \begin{itemize}
...
\section*{Today}
\label{sec:org7f8f327}
\begin{frame}[label={sec:org6c59894}]{Agenda}
\begin{itemize}
...
\begin{frame}[label={sec:org16305fb},fragile]{Before we start}
 \begin{minted}[]{bash}
...
\section{Type theory}
\label{sec:org0d19747}
\begin{frame}[label={sec:org235d995}]{Values and types}
...
\begin{frame}[label={sec:orgd4091a0},fragile]{Nullary value constructors}
...
\begin{frame}[label={sec:org0fc60ef},fragile]{Unary value constructors: function}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org3eefd71},fragile]{Unary value constructors: class}
...
\begin{frame}[label={sec:org6ce45e3},fragile]{Higher arity}
...
\begin{frame}[label={sec:org5fdf7a4},fragile]{Nullary type constructors}
...
\begin{frame}[label={sec:orge7fe82f},fragile]{Unary type constructors}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgc5d1826},fragile]{Higher arity}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org852c83b},fragile]{Kinds}
...
\begin{frame}[label={sec:org88ac493},fragile]{Examples}
 \begin{itemize}
...
\begin{frame}[label={sec:org5ef6a50},fragile]{Higher-order functions}
...
\begin{frame}[label={sec:orgb289a84},fragile]{Higher-order types (1)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org4e44bbf},fragile]{Higher-order types (2)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgd11ca0b}]{Higher-order types (3)}
...
\begin{frame}[label={sec:orgf5d1442}]{The most important question}
\begin{center}
...
\section{Functor}
\label{sec:orgf9d6627}
\begin{frame}[label={sec:org2a2ee75}]{Function Application}
...
\begin{frame}[label={sec:org28b368f},fragile]{Function Application}
...
\begin{frame}[label={sec:org909c312},fragile]{Function Application}
...
\begin{frame}[label={sec:orgf202c24},fragile]{Context: optional value}
...
\begin{frame}[label={sec:org0cba526},fragile]{Context: optional value}
 \begin{itemize}
...
\begin{frame}[label={sec:org0ae7fb5},fragile]{Context: optional value}
 \begin{minted}[]{scala}
//  apply        : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:orgfba987c},fragile]{Many contexts}
 \begin{itemize}
...
\begin{frame}[label={sec:org19f2ff8},fragile]{Many applies}
 \begin{minted}[]{scala}
def apply           : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:orgdca3b71}]{Repetition is}
\begin{center}
...
\begin{frame}[label={sec:org8355057},fragile]{Functoriana}
 \begin{minted}[]{scala}
trait Functor[F[_]] {
...
\begin{frame}[label={sec:orgb61cb49},fragile]{Code responsibly, know the laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:orge9e174b}]{Sum type: Option}
\begin{center}
...
\begin{frame}[label={sec:org43d17ac},fragile]{Breaking the Option}
 \begin{minted}[]{scala}
  fmap(identity)(value)
= identity(value)
= value
...
\begin{frame}[label={sec:orgc8fce0f},fragile]{Product type: List}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orga47aa74},fragile,t]{Breaking the List}
 \begin{onlyenv}<1-2>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org022ac95}]{What about the second rule?}
...
\begin{frame}[label={sec:org3e01b3f}]{There can be only one}
There is only one lawful implementation of Functor for a given type.
\end{frame}

\begin{frame}[label={sec:orgaae8163},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org6bb4770},fragile]{Outcome}
 \begin{itemize}
...
\label{sec:org63db9a2}

\begin{frame}[label={sec:org63b45c9},fragile]{Next step}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:org09d7fc3},fragile]{Next step}
 \begin{minted}[]{scala}
def apply :  (A => B) =>   A  =>   B
...
\begin{frame}[label={sec:org8673d6b},fragile]{Solution}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:org39d244c},fragile]{Following the same idea}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orga0dc601},fragile]{What's about pure?}
 \begin{columns}
...
\begin{frame}[label={sec:org5dc84d4},fragile]{Another perspective}
...
\begin{frame}[label={sec:orga633526},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgc34057e},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org5efe84a},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgd42d029},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgd8716c8},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgeb182fb},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org50e5f4b},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{minted}[]{scala}
class MonoidalToApplicative[F[_]: Monoidal]() extends Applicative[F] {
  override def pure[A](a: A): F[A] = Monoidal[F].unit.fmap(_ => a)
...
\begin{frame}[label={sec:orgc5ee3f7},fragile]{Monoid part of \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Monoid[A] {
...
\begin{frame}[label={sec:org49f9374},fragile]{Applicative laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:org2976989},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:orgf07278c},fragile]{Conditionals}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org3dba76a},fragile]{Outcome}
 \begin{itemize}
...
\section{Parsing}
\label{sec:org0f70013}

\begin{frame}[label={sec:org81d67cb},fragile,t]{Parsing}
 \vspace*{20px}
...
\begin{frame}[label={sec:orga0c48e3},fragile,t]{Simple parser}
 \begin{minted}[]{scala}
case class Parser[A](parse: String => ParserResult[A])
\end{minted}
...
\begin{frame}[label={sec:org0fbfb69},fragile]{Abstracting \texttt{char}}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org0022629},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgae366c0},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org4c4335e},fragile,t]{(invalid) UUID parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org01a0ca7},fragile,t]{Space invaders}
 \begin{minted}[]{scala}
def uuid: Parser[String] = /* ... */
...
\begin{frame}[label={sec:orgf44590e}]{So\ldots{}}
\begin{center}
\includegraphics[height=5cm]{images/applicative-confusion.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgd6a2dcb},fragile,t]{Simple case class example}
 \begin{onlyenv}<1->
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org2ba839a},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:orgaa9a0e6}]{Outcome}
\begin{itemize}
...
\section{Validation}
\label{sec:org93d18c3}

\begin{frame}[label={sec:org1b926e7},fragile]{Validation}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org41aa336},fragile]{Person}
 \begin{minted}[]{scala}
case class Person(name: String, age: Int)
\end{minted}
...
\begin{frame}[label={sec:org2ee4992},fragile]{Person}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org0db4dcc},fragile]{Quest for 'all errors'}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orga6ef037},fragile]{What's wrong with Either?}
...
\begin{frame}[label={sec:org7adb87e},fragile]{Doing as much as we can}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org25a2ead},fragile]{Coding time}
 \begin{itemize}
...
\section*{Final words}
\label{sec:org67bf25f}
\begin{frame}[label={sec:org9bbfc5e},fragile]{Recap}
 \begin{onlyenv}
\begin{itemize}
...
\section{Questions?}
\label{sec:orgd24fcb6}

\section{Thank you very much!}
\label{sec:orgf081ad3}
\end{document}
