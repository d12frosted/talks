...
\section*{Intro}
\label{sec:orgc45711a}
\begin{frame}[label={sec:org7b18244}]{About us}
\vspace*{20px}
...
\begin{frame}[label={sec:org9c4b3b6}]{About the Forkshop}
\begin{itemize}
...
\begin{frame}[label={sec:org5c26e1f},fragile]{Whys}
 \begin{itemize}
...
\section*{Today}
\label{sec:org31ea66b}
\begin{frame}[label={sec:orgd8e404e}]{Agenda}
\begin{itemize}
...
\begin{frame}[label={sec:org1864a0b},fragile]{Before we start}
 \begin{minted}[]{bash}
...
\section{Type theory}
\label{sec:orga865272}
\begin{frame}[label={sec:orge4cfa38}]{Values and types}
...
\begin{frame}[label={sec:orgb00d658},fragile]{Nullary value constructors}
...
\begin{frame}[label={sec:org577647f},fragile]{Unary value constructors: function}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org97d5b70},fragile]{Unary value constructors: class}
...
\begin{frame}[label={sec:org10ec0a3},fragile]{Higher arity}
...
\begin{frame}[label={sec:org24a291a},fragile]{Nullary type constructors}
...
\begin{frame}[label={sec:org0ef9788},fragile]{Unary type constructors}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orga48afb0},fragile]{Higher arity}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgf249f2b},fragile]{Kinds}
...
\begin{frame}[label={sec:org7abf64c},fragile]{Examples}
 \begin{itemize}
...
\begin{frame}[label={sec:org81d4a44},fragile]{Higher-order functions}
...
\begin{frame}[label={sec:org19f010d},fragile]{Higher-order types (1)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgab612a6},fragile]{Higher-order types (2)}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org8a1e8d3}]{Higher-order types (3)}
...
\begin{frame}[label={sec:orgf73cea0}]{The most important question}
\begin{center}
...
\section{Functor}
\label{sec:org2dd27a2}
\begin{frame}[label={sec:orgd8e11b8}]{Function Application}
...
\begin{frame}[label={sec:orgd34317e},fragile]{Function Application}
...
\begin{frame}[label={sec:org9024fda},fragile]{Function Application}
...
\begin{frame}[label={sec:orgf507583},fragile]{Context: optional value}
...
\begin{frame}[label={sec:orgef67e2c},fragile]{Context: optional value}
 \begin{itemize}
...
\begin{frame}[label={sec:orgf8ea003},fragile]{Context: optional value}
 \begin{minted}[]{scala}
//  apply        : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:orge0cc9ab},fragile]{Many contexts}
 \begin{itemize}
...
\begin{frame}[label={sec:orgb8e0483},fragile]{Many applies}
 \begin{minted}[]{scala}
def apply           : (A => B) =>        A  =>        B
...
\begin{frame}[label={sec:orgf9b78af}]{Repetition is}
\begin{center}
...
\begin{frame}[label={sec:org79e0221},fragile]{Functoriana}
 \begin{minted}[]{scala}
trait Functor[F[_]] {
...
\begin{frame}[label={sec:orgd16067d},fragile]{Code responsibly, know the laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:orge4c8631}]{Sum type: Option}
\begin{center}
...
\begin{frame}[label={sec:org50241f3},fragile]{Breaking the Option}
 \begin{minted}[]{scala}
  fmap(identity)(value)
= identity(value)
= value
...
\begin{frame}[label={sec:orgff039a4},fragile]{Product type: List}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org20054eb},fragile,t]{Breaking the List}
 \begin{onlyenv}<1-2>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org4d8f68b}]{What about the second rule?}
...
\begin{frame}[label={sec:org7e4bb18}]{There can be only one}
There is only one lawful implementation of Functor for a given type.
\end{frame}

\begin{frame}[label={sec:org471f3d8},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:org08b00a2},fragile]{Outcome}
 \begin{itemize}
...
\label{sec:org00bf67b}

\begin{frame}[label={sec:org79b97ad},fragile]{Next step}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:org7ea1073},fragile]{Next step}
 \begin{minted}[]{scala}
def apply :  (A => B) =>   A  =>   B
...
\begin{frame}[label={sec:org051cd70},fragile]{Solution}
 \begin{minted}[]{scala}
val v1 = Option(42)
val v2 = Option(100)
...
\begin{frame}[label={sec:orgc59d0b0},fragile]{Following the same idea}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org7452dd4},fragile]{What's about pure?}
 \begin{columns}
...
\begin{frame}[label={sec:orgd41bc72},fragile]{Another perspective}
...
\begin{frame}[label={sec:org17fb50f},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org24beb8c},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org2bab30a},fragile]{From \texttt{Applicative} to \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org44625b2},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org1e13b42},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:org7387fc5},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Applicative[F[_]] extends Functor[F] {
...
\begin{frame}[label={sec:orgb6321a5},fragile]{From \texttt{Monoidal} to \texttt{Applicative}}
 \begin{minted}[]{scala}
class MonoidalToApplicative[F[_]: Monoidal]() extends Applicative[F] {
  override def pure[A](a: A): F[A] = Monoidal[F].unit.fmap(_ => a)
...
\begin{frame}[label={sec:orgf2a765e},fragile]{Some symmetry}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org02a0df0},fragile]{Monoid part of \texttt{Monoidal}}
 \begin{columns}
\begin{column}[t]{0.5\columnwidth}
\begin{minted}[]{scala}
trait Monoid[A] {
...
\begin{frame}[label={sec:org5c3b6c5},fragile]{Applicative laws}
 \begin{enumerate}
...
\begin{frame}[label={sec:orga2a19b8},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:orgd64aef2},fragile]{Conditionals}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgdbdf277},fragile]{Outcome}
 \begin{itemize}
...
\section{Parsing}
\label{sec:orgd1fb767}

\begin{frame}[label={sec:orgc5648d2},fragile,t]{Parsing}
 \vspace*{20px}
...
\begin{frame}[label={sec:org904fe98},fragile,t]{Simple parser}
 \begin{minted}[]{scala}
case class Parser[A](parse: String => ParserResult[A])
\end{minted}
...
\begin{frame}[label={sec:orgc40e886},fragile]{Abstracting \texttt{char}}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org055663f},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgd0b4673},fragile,t]{Repeating the parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org71c097c},fragile,t]{(invalid) UUID parser}
 \begin{onlyenv}<1>
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:org733428f},fragile,t]{Space invaders}
 \begin{minted}[]{scala}
def uuid: Parser[String] = /* ... */
...
\begin{frame}[label={sec:orgde0ae75}]{So\ldots{}}
\begin{center}
\includegraphics[height=5cm]{images/applicative-confusion.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:org0973ae3},fragile,t]{Simple case class example}
 \begin{onlyenv}<1->
\begin{minted}[]{scala}
...
\begin{frame}[label={sec:orgfc40ea0},fragile]{Coding time}
 \begin{itemize}
...
\begin{frame}[label={sec:orgb471ba6}]{Outcome}
\begin{itemize}
...
\section{Validation}
\label{sec:org9ddb1a7}

\begin{frame}[label={sec:orgb2736c8},fragile]{Validation}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org93fe0be},fragile]{Person}
 \begin{minted}[]{scala}
case class Person(name: String, age: Int)
\end{minted}
...
\begin{frame}[label={sec:orgb73313b},fragile]{Person}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org0c10fbd},fragile]{Quest for 'all errors'}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org69053a0},fragile]{What's wrong with Either?}
...
\begin{frame}[label={sec:org7a3acd0},fragile]{Doing as much as we can}
 \begin{minted}[]{scala}
...
\begin{frame}[label={sec:org1076061},fragile]{Coding time}
 \begin{itemize}
...
\section*{Final words}
\label{sec:orga2872ca}
\begin{frame}[label={sec:orge8d35e5},fragile]{Recap}
 \begin{onlyenv}
\begin{itemize}
...
\section*{References}
\label{sec:org10bf152}
\begin{frame}[label={sec:orga169f75}]{References}
\begin{itemize}
...
\section{Questions?}
\label{sec:orgc41af7e}

\section{Thank you very much!}
\label{sec:orgb129826}
\end{document}
