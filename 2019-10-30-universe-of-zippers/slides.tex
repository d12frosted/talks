...
\section*{Intro}
\label{sec:org7ab00d2}
\begin{frame}[label={sec:orgd7a6742}]{About me}
\begin{columns}
...
\begin{frame}[label={sec:orgd4f9fe1}]{Agenda}
\begin{itemize}
...
\label{sec:orga7568bf}

\begin{frame}[label={sec:org3a267ea}]{Cellular Automaton}
...
\begin{frame}[label={sec:org850ebc9}]{Many grids}
\begin{enumerate}
...
\begin{frame}[label={sec:orgc553a79},t]{Elementary Cellular Automata}
\begin{onlyenv}<1->
...
\begin{frame}[label={sec:org22b3b87}]{ECA: specifying the rule}
\begin{columns}
...
\begin{frame}[label={sec:orgac6237a}]{M-x doctor}
\begin{verse}
...
\begin{frame}[label={sec:org4542d75},fragile]{All possible shifts}
 \begin{onlyenv}<1>
\begin{minted}[]{haskell}
duplicate :: U a -> U (U a)
\end{minted}
...
\begin{frame}[label={sec:org19a521c}]{All possible shifts}
\begin{gather*}
...
\begin{frame}[label={sec:org8f2a6bf}]{Where's the focus?}
\begin{gather*}
  \dots\ 0\ 1\ (2)\ 3\ 4\ 5\ \dots \\
...
\begin{frame}[label={sec:orgbfbb62e}]{Where's the focus?}
\begin{gather*}
  \dots\ 0\ 1\ (2)\ 3\ 4\ 5\ \dots \\
...
\begin{frame}[label={sec:org0aa3f30}]{Where's the focus}
\begin{gather*}
  \dots\ 0\ 1\ (2)\ 3\ 4\ 5\ \dots \\
...
\begin{frame}[label={sec:org5f74294}]{Example of simulation (1)}
\begin{footnotesize}
  \begin{equation*}
    \begingroup
    \setlength\arraycolsep{0.25pt}
...
\begin{frame}[label={sec:orga18872b}]{Example of simulation (2)}
\begin{equation*}
  \begingroup
  \setlength\arraycolsep{0.25pt}
  \renewcommand{\arraystretch}{0.5}
...
\begin{frame}[label={sec:org1b09c8f}]{Example of simulation (3)}
\begin{tiny}
  \begin{equation*}
    \begingroup
    \setlength\arraycolsep{0.25pt}
...
\begin{frame}[label={sec:orgb8bc350}]{\emph{untitled copy (1)(2) - final}}
\begin{onlyenv}<1>
iTunes anyone?
\end{onlyenv}
...
\begin{frame}[label={sec:org6ec9e2c},fragile]{Rolling out U2}
 \begin{minted}[]{haskell}
type U2 a = U (U a)
\end{minted}
\end{frame}
...
\begin{frame}[label={sec:orgbcca934},fragile]{Extending 2D Universe (2)}
 \begin{minted}[]{haskell}
...
\label{sec:org81eaa86}

\begin{frame}[label={sec:orgb0f9317}]{Definition}
\pause

Do you really need a definition of Bomberman?
\end{frame}

\begin{frame}[label={sec:org9ee0f16}]{Definition}
\begin{center}
\includegraphics[width=.9\linewidth]{images/bomberman-1.jpg}
\end{center}
\end{frame}

\begin{frame}[label={sec:org57862bb}]{But we have a different one}
\begin{center}
\includegraphics[height=8cm]{images/bomberman-2.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:org81c3fda}]{Bells and whistles}
\begin{center}
\includegraphics[height=8cm]{images/bomberman-3.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:org8fc809c},fragile]{Reusing U2}
 \begin{minted}[]{haskell}
data Cell
  = Bomberman
  | BombBomberman
...
\begin{frame}[label={sec:org4ec8a5e},fragile]{What is bot?}
 \begin{minted}[]{haskell}
bot :: ( MonadIO m
       , MonadReader r m
       , HasLogFunc r
...
\begin{frame}[label={sec:org3cf96ed}]{What we care about}
\begin{itemize}
...
\begin{frame}[label={sec:orgef593a1},fragile]{Fatum of the Universe}
 \begin{minted}[]{haskell}
data MarkedCell
  = MarkedCell
  { getCell        :: !Cell
...
\begin{frame}[label={sec:org6cc7803},fragile]{Fatum of the Universe}
 \begin{minted}[]{haskell}
> :t extend
...
\begin{frame}[label={sec:org1513365},fragile,t]{The bot}
 \begin{onlyenv}<1>
\begin{minted}[]{haskell}
bot :: ( MonadIO m
       , MonadReader r m
...
\begin{frame}[label={sec:orga5799a6}]{Danger! Live demo}
...
\begin{frame}[label={sec:org3761249},fragile]{Comonad}
 \begin{minted}[]{haskell}
...
\begin{frame}[label={sec:orgfb43270},fragile]{Co-monad}
 \begin{columns}
\begin{column}{0.45\columnwidth}
\begin{minted}[]{haskell}
extract :: f a -> a
...
\begin{frame}[label={sec:orga257ea1},fragile]{Universe is Comonad}
...
\section*{References}
\label{sec:orgb04ffd3}
\begin{frame}[label={sec:org0f508cd}]{References}
\begin{itemize}
...
\section{Questions?}
\label{sec:org5ebf79e}
\section{Thank you}
\label{sec:org9c8de60}
\end{document}
